---
description: First time coming into contact with Hi3403 / Hi3403? Start here.
title: Get started
---
...
-   :material-cog-outline:{ .lg .middle } __Select operating system__
...
-   :material-tools:{ .lg .middle } __Install development environment__
...
-   :material-package-down:{ .lg .middle } __Install SDK__
...
-   :material-usb-port:{ .lg .middle } __Driver and development environment installation__
...
-   :material-source-branch:{ .lg .middle } __Upstream SDK Quick Start__
...
-   :material-package-variant:{ .lg .middle } __One-click build: hi3403-build__
...
-   :material-bookshelf:{ .lg .middle } __Glossary__
