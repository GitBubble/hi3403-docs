...
![](figures/提升小脸亮度的Asmmetry曲线形状.png "Asymmetry Curve Shape for Brightening Face")
...
![](figures/texture_freq的调节效果示意图.png "Single Sensor Capturing Image Information")
...
![](figures/edge_freq的调节效果示意图.png "Demosaic Function")
...
![](figures/shoot_sup_strength的调节效果示意图.png "NR Functional Principle Diagram")
