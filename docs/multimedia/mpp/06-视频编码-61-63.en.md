...
![](figures/编码通道功能模块划分.png "编码channelfunctionmodule划分")
...
![](figures/OT_VENC_GOP_MODE_DUAL_P模式的帧结构图.png "OT_VENC_GOP_MODE_DUAL_PMode的帧结构图")
...
![](figures/OT_VENC_GOP_MODE_SMART_P模式的帧结构图.png "OT_VENC_GOP_MODE_SMART_PMode的帧结构图")
...
![](figures/OT_VENC_GOP_MODE_ADV_SMART_P模式的帧结构图.png "OT_VENC_GOP_MODE_ADV_SMART_PMode的帧结构图")
...
![](figures/OT_VENC_GOP_MODE_BIPRED_B模式的帧结构图.png "OT_VENC_GOP_MODE_BIPRED_BMode的帧结构图")
>![](public_sys-resources/icon-note.gif) **Note:** 
...
![](figures/编码码流帧配置模式.png "编码码流帧configurationMode")
