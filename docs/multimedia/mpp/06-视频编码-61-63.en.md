...
![](figures/VENCDatastreamgraph.png "VENC Data Flow Diagram")
...
![](figures/Encoding ChannelFunctionModule划.png "Encoding Channel Functional Module Division")
...
![](figures/H-265-QPMAP-LCU(64-64)arrangePosition.png "H-265-QPMAP-LCU(64-64)arrangePosition")

**Figure 2** H.264 QPMAP MB Layout Position<a name="fig1569611155114"></a>  
![](figures/H-264-QPMAP-MBarrangePosition.png "H-264-QPMAP-MBarrangePosition")

**Figure 3** H.265 SkipWeight Table Layout\(64\*64\)<a name="fig16647191164915"></a>  
![](figures/H-265-SkipWeightmeterLayout(64-64).png "H-265-SkipWeightmeterLayout(64-64)")

**Figure 4** H.264 SkipWeight Table Layout\(16\*16\)<a name="fig86961774508"></a>  
![](figures/H-264-SkipWeightmeterLayout(16-16).png "H-264-SkipWeightmeterLayout(16-16)")
...
![](figures/OT_VENC_GOP_MODE_DUAL_PModeFrameStructure Diagram.png "OT_VENC_GOP_MODE_DUAL_P Mode Frame Structure Diagram")
...
![](figures/OT_VENC_GOP_MODE_SMART_PModeFrameStructure Diagram.png "OT_VENC_GOP_MODE_SMART_P Mode Frame Structure Diagram")
...
![](figures/OT_VENC_GOP_MODE_ADV_SMART_PModeFrameStructure Diagram.png "OT_VENC_GOP_MODE_ADV_SMART_P Mode Frame Structure Diagram")
...
![](figures/OT_VENC_GOP_MODE_BIPRED_BModeFrameStructure Diagram.png "OT_VENC_GOP_MODE_BIPRED_B Mode Frame Structure Diagram")
>![](public_sys-resources/icon-note.gif) **Note:** 
...
![](figures/normal_pHeightLeveljumpFrameReferenceSchematic Diagram.png "normal_p Advanced Skip Frame Reference Diagram")

**Figure 2**  smart\_p Advanced Skip Frame Reference Diagram<a name="fig3562445133913"></a>  
![](figures/smart_pHeightLeveljumpFrameReferenceSchematic Diagram.png "smart_p Advanced Skip Frame Reference Diagram")

**Figure 3**  adv\_smart\_p Advanced Skip Frame Reference Diagram<a name="fig18536656124016"></a>  
![](figures/adv_smart_pHeightLeveljumpFrameReferenceSchematic Diagram.png "adv_smart_p Advanced Skip Frame Reference Diagram")
...
![](figures/bipred_bHeightLeveljumpFrameReferenceSchematic Diagram.png "bipred_b Advanced Skip Frame Reference Diagram")
![](figures/6-16-2.png)
...
![](figures/CropEncodingSchematic Diagram.png "Crop Encoding Diagram")
...
![](figures/EncodingBitstreamFrameConfigure Mode.png "Encoding Stream Frame Configuration Mode")
...
-   When one\_stream\_buf is 1, the user will only get the address of one stream packet (excluding user data) when retrieving one frame stream, i.e., pack\_cnt is 1, and the address is pack\[0\].addr. An offset field is added to the ot\_venc\_pack struct to indicate the offset between the address of valid data in the one-frame stream and pack\[0\].addr. As shown in Figure 1 (taking H.264 single-packet mode as an example), pack\[0\].data\_num = 3, i.e., 3 types of NAL packets, which are SPS, PPS, and SEI respectively. pack\[0\].pack\_info\[0\].pack\_type.h264\_type = OT\_VENC\_H264\_NALU\_SPS, pack\[0\].pack\_info\[1\].pack\_type.h264\_type = OT\_VENC\_H264\_NALU\_PPS, pack\[0\].pack\_info\[2\].pack\_type.h264\_type = OT\_VENC\_H264\_NALU\_SEI; the same logic applies to other protocols by analogy. data\_num and pack\_info are only meaningful in single-packet mode.
    ...
    **Figure 1**  Stream Packet Structure Diagram<a name="fig1125873818118"></a>  
    ![](figures/BitstreamPacketStructure Diagram.png "Stream Packet Structure Diagram")
...
![](figures/BitstreamPacketStructure Diagram-1.png "Stream Packet Structure Diagram-1")
...
-   SS528V100/SS625V100/SS524V100/SS522V101/SS626V100Not supportedthis interface,  OnlySS928V100Supported.
...
-   SS528V100/SS625V100/SS524V100/SS522V101/SS928V100/SS626V100Not supportedQuantization Table. 
...
-   Advanced ParametersMainlyBy FiveParameterGroup
    ...
    -   ecs\_output\_en: OnlySS928V100/SS626V100Supported, Not supportedDefault value is TD\_FALSE.
...
-   SS528V100/SS625V100/SS524V100/SS522V101/SS928V100/SS626V100Solution , CorrespondingBindVPSS ChannelSupportedCompressionandNon-CompressionFormatOutput.
...
-   SliceSplitAttributeMainlybyThe followingParameterDetermines
    ...
    -   slice\_output\_en: OnlySS928V100/SS626V100/SS524V100/SS528V100Supported, Not supportedDefault value is TD\_FALSE, Whenslice\_output\_en as TD\_TRUEwhen, Channel attributeis\_by\_framemust be TD\_FALSE, Whenslice\_output\_en as TD\_TRUEwhenOnly supportedsplit\_mode = 1Mode.
...
![](figures/loseFrameSchematic Diagram.png "loseFrameshown意graph")
...
-   VPSS-VENC处AtWindingLow Latencyin mode, Not supportedSuper LargeFrameheavycodec, strongmakeConfigure May CauseChannelFrequentloseFrame.SS528V100/SS625V100/SS524V100/SS522V101/SS928V100/SS626V100Not supportedWindingLow Latency.
...
<p id="p8830mcpsimp"><a name="p8830mcpsimp"></a><a name="p8830mcpsimp"></a>SS528V100/SS625V100/SS524V100/SS522V101/SS928V100/SS626V100lcu_size as 32; </p>
</td>
</tr>
...
-   OnlySS928V100H.264Encoding ChannelSupportedthis interface, H.265fullSupported.
...
![](figures/normal_pLayerQPSchematic Diagram.png "normal_pLayerQPshown意graph")

**Figure 2**  smart\_p/adv\_smart\_ppLayerQPSchematic Diagram<a name="fig16586145618411"></a>  
![](figures/smart_p-adv_smart_ppLayerQPSchematic Diagram.png "smart_p-adv_smart_ppLayerQPshown意graph")
...
-   Only supported on SS928V100/SS626V100.
