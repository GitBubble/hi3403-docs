...
<p id="p220mcpsimp"><a name="p220mcpsimp"></a><a name="p220mcpsimp"></a>( do not support PCIV)</p>
</td>
...
</table> **Table 2** Hi3403V100 region supported module information <a name="_Ref28008823"></a>
...
</table> - Region Supported Features The features supported by various region types are shown in [Table 3](#_Ref17904683) and [Table 4](#_Ref28008926). >![](public_sys-resources/icon-note.gif) **Note:**
>- The VO module only supports region in single mode, not in multi mode.
>- When PCIV (Peripheral Component Interconnect Video) overlays regions, only the slave chip supports region overlay; the master chip does not support it. **Table 3** region supported features <a name="_Ref17904683"></a>
...
<p id="p520mcpsimp"><a name="p520mcpsimp"></a><a name="p520mcpsimp"></a>PCIV ( do not support PCIV)</p>
...
</table> **Table 4** Hi3403V100 region supported features <a name="_Ref28008926"></a>
...
</table> **Table 5** region COVER/COVEREX type support <a name="table896mcpsimp"></a>
...
</table> **Table 6** Hi3403V100 region COVER/COVEREX type support <a name="table971mcpsimp"></a>
