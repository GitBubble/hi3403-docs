...
-   SS928V100解码输出OT\_VIDEO\_FORMAT\_TILE\_64x16格式时不支持旋转，会返回错误码OT\_ERR\_VDEC\_NOT\_SUPPORT。
...
-   仅SS928V100/SS626V100支持此接口，其他解决方案调用时会返回OT\_ERR\_VDEC\_NOT\_SUPPORT。
