...
- [ot\_vo\_register\_export\_callback](#ZH-CN_TOPIC_0000002470925664): Defines the registered interrupt callback hook function. ## OT\_VO\_MAX\_PHYS\_DEV\_NUM<a name="ZH-CN_TOPIC_0000002504085559"></a> **Description** Defines the maximum number of video output physical devices. **Definition** : ```
#define OT_VO_MAX_PHYS_DEV_NUM 3
``` Hi3403V100: ```
#define OT_VO_MAX_PHYS_DEV_NUM 2
``` **Solution Differences** <a name="table11583mcpsimp"></a>
...
</table> **Notes** does not support DHD1. **Related Data Types and Interfaces** None. ## OT\_VO\_MAX\_VIRT\_DEV\_NUM<a name="ZH-CN_TOPIC_0000002504085601"></a> **Description** Defines the maximum number of virtual video output devices. **Definition** Hi3403V100: ```
#define OT_VO_MAX_VIRT_DEV_NUM 32
``` **Solution Differences** <a name="table11619mcpsimp"></a>
...
<tbody><tr id="row11630mcpsimp"><td class="cellrowborder" valign="top" width="41%" headers="mcps1.1.3.1.1 "><p id="p11632mcpsimp"><a name="p11632mcpsimp"></a><a name="p11632mcpsimp"></a>Hi3403V100<span xml:lang="x-NONE" id="ph11633mcpsimp"><a name="ph11633mcpsimp"></a><a name="ph11633mcpsimp"></a></span></p>
</td>
...
</table> **Notes** None. **Related Data Types and Interfaces** None. ## OT\_VO\_MAX\_CAS\_DEV\_NUM<a name="ZH-CN_TOPIC_0000002503965613"></a> **Description** Defines the maximum number of video output cascade extension devices. **Definition** : ```
#define OT_VO_MAX_CAS_DEV_NUM 2
``` Hi3403V100: ```
#define OT_VO_MAX_CAS_DEV_NUM 0
``` **Solution Differences** <a name="table11650mcpsimp"></a>
...
<tr id="row11666mcpsimp"><td class="cellrowborder" valign="top" width="46%" headers="mcps1.1.3.1.1 "><p id="p11668mcpsimp"><a name="p11668mcpsimp"></a><a name="p11668mcpsimp"></a> /Hi3403V100<span xml:lang="x-NONE" id="ph11669mcpsimp"><a name="ph11669mcpsimp"></a><a name="ph11669mcpsimp"></a></span></p>
</td>
...
</table> **Notes** None. **Related Data Types and Interfaces** None. ## OT\_VO\_MAX\_DEV\_NUM<a name="ZH-CN_TOPIC_0000002470925732"></a> **Description** Defines the maximum number of video output devices. **Definition** Hi3403V100: ```
#define OT_VO_MAX_DEV_NUM (OT_VO_MAX_PHYS_DEV_NUM + OT_VO_MAX_VIRT_DEV_NUM + OT_VO_MAX_CAS_DEV_NUM)
``` **Solution Differences** <a name="table11687mcpsimp"></a>
...
</table> **Notes** does not support DHD1. **Related Data Types and Interfaces** None. ## OT\_VO\_VIRT\_DEV\_0<a name="ZH-CN_TOPIC_0000002470925654"></a> **Description** Defines the Device number for virtual device 0. **Definition** : ```
#define OT_VO_VIRT_DEV_0 3
``` Hi3403V100: ```
#define OT_VO_VIRT_DEV_0 2
``` **Solution Differences** <a name="table11744mcpsimp"></a>
...
</table> **Notes** None. **Related Data Types and Interfaces** None. ## OT\_VO\_VIRT\_DEV\_1<a name="ZH-CN_TOPIC_0000002503965607"></a> **Description** Defines the Device number for virtual device 1. **Definition** : ```
#define OT_VO_VIRT_DEV_1 4
``` Hi3403V100: ```
#define OT_VO_VIRT_DEV_1 3
``` **Solution Differences** <a name="table11782mcpsimp"></a>
...
</table> **Notes** None. **Related Data Types and Interfaces** None. ## OT\_VO\_VIRT\_DEV\_2<a name="ZH-CN_TOPIC_0000002471085650"></a> **Description** Defines the Device number for virtual device 2. **Definition** : ```
#define OT_VO_VIRT_DEV_2 5
``` Hi3403V100: ```
#define OT_VO_VIRT_DEV_2 4
``` **Solution Differences** <a name="table11820mcpsimp"></a>
...
</table> **Notes** None. **Related Data Types and Interfaces** None. ## OT\_VO\_VIRT\_DEV\_3<a name="ZH-CN_TOPIC_0000002504085589"></a> **Description** Defines the Device number for virtual device 3. **Definition** : ```
#define OT_VO_VIRT_DEV_3 6
``` Hi3403V100: ```
#define OT_VO_VIRT_DEV_3 5
``` **Solution Differences** <a name="table11858mcpsimp"></a>
...
</table> **Notes** None. **Related Data Types and Interfaces** None. ## OT\_VO\_CAS\_DEV\_1<a name="ZH-CN_TOPIC_0000002471085638"></a> **Description** Defines the Device number for cascade device 1. **Definition** : ```
#define OT_VO_CAS_DEV_1 35
``` **Solution Differences** <a name="table11891mcpsimp"></a>
...
<tr id="row11907mcpsimp"><td class="cellrowborder" valign="top" width="42%" headers="mcps1.1.3.1.1 "><p id="p11909mcpsimp"><a name="p11909mcpsimp"></a><a name="p11909mcpsimp"></a>Hi3403V100<span xml:lang="x-NONE" id="ph11910mcpsimp"><a name="ph11910mcpsimp"></a><a name="ph11910mcpsimp"></a></span></p>
</td>
...
</table> **Notes** None. **Related Data Types and Interfaces** None. ## OT\_VO\_CAS\_DEV\_2<a name="ZH-CN_TOPIC_0000002471085660"></a> **Description** Defines the Device number for cascade device 2. **Definition** ```
#define OT_VO_CAS_DEV_2 36
``` **Solution Differences** <a name="table11924mcpsimp"></a>
...
<tr id="row11940mcpsimp"><td class="cellrowborder" valign="top" width="37%" headers="mcps1.1.3.1.1 "><p id="p11942mcpsimp"><a name="p11942mcpsimp"></a><a name="p11942mcpsimp"></a>Hi3403V100<span xml:lang="x-NONE" id="ph11943mcpsimp"><a name="ph11943mcpsimp"></a><a name="ph11943mcpsimp"></a></span></p>
</td>
...
</table> **Notes** None. **Related Data Types and Interfaces** None. ## OT\_VO\_MAX\_PHYS\_VIDEO\_LAYER\_NUM<a name="ZH-CN_TOPIC_0000002504085565"></a> **Description** Defines the maximum number of physical video layers. **Definition** : ```
#define OT_VO_MAX_PHYS_VIDEO_LAYER_NUM 4
``` Hi3403V100: ```
#define OT_VO_MAX_PHYS_VIDEO_LAYER_NUM 3
``` **Solution Differences** <a name="table11962mcpsimp"></a>
...
</table> **Notes** Not supported VHD1. **Related Data Types and Interfaces** None. ## OT\_VO\_MAX\_GFX\_LAYER\_NUM<a name="ZH-CN_TOPIC_0000002470925738"></a> **Description** Defines the maximum number of graphics layers. **Definition** : ```
#define OT_VO_MAX_GFX_LAYER_NUM 4
``` Hi3403V100: ```
#define OT_VO_MAX_GFX_LAYER_NUM 3
``` : ```
#define OT_VO_MAX_GFX_LAYER_NUM 5
``` **Solution Differences** <a name="table12000mcpsimp"></a>
...
</table> **Notes** Not supportedG1. **Related Data Types and Interfaces** None. ## OT\_VO\_MAX\_PHYS\_LAYER\_NUM<a name="ZH-CN_TOPIC_0000002504085591"></a> **Description** Defines the maximum number of physical video layers and graphics layers. **Definition** Hi3403V100: ```
#define OT_VO_MAX_PHYS_LAYER_NUM (OT_VO_MAX_PHYS_VIDEO_LAYER_NUM + OT_VO_MAX_GFX_LAYER_NUM)
``` **Solution Differences** <a name="table12041mcpsimp"></a>
...
</table> **Notes** does not support VHD1 and G1. **Related Data Types and Interfaces** None. ## OT\_VO\_MAX\_LAYER\_NUM<a name="ZH-CN_TOPIC_0000002504085535"></a> **Description** Defines the maximum number of all video layers and graphics layers. **Definition** Hi3403V100: ```
#define OT_VO_MAX_LAYER_NUM (OT_VO_MAX_PHYS_LAYER_NUM + OT_VO_MAX_VIRT_DEV_NUM + OT_VO_MAX_CAS_DEV_NUM)
``` **Solution Differences** <a name="table12083mcpsimp"></a>
...
</table> **Notes** does not support VHD1 and G1. **Related Data Types and Interfaces** None. ## OT\_VO\_MAX\_LAYER\_IN\_DEV<a name="ZH-CN_TOPIC_0000002504085499"></a> **Description** Specifies the largest number of video layers on each device. **Definition** Hi3403V100: ```
#define OT_VO_MAX_LAYER_IN_DEV 2
``` **Solution Differences** <a name="table12137mcpsimp"></a>
...
<tbody><tr id="row12148mcpsimp"><td class="cellrowborder" valign="top" width="56.99999999999999%" headers="mcps1.1.3.1.1 "><p id="p12150mcpsimp"><a name="p12150mcpsimp"></a><a name="p12150mcpsimp"></a>Hi3403V100<span xml:lang="x-NONE" id="ph12151mcpsimp"><a name="ph12151mcpsimp"></a><a name="ph12151mcpsimp"></a></span></p>
</td>
...
</table> **Notes** Refers only to video layers, excluding graphics layers. **Related Data Types and Interfaces** None. ## OT\_VO\_LAYER\_V0<a name="ZH-CN_TOPIC_0000002504085501"></a> **Description** Defines the layer number for video layer 0. **Definition** Hi3403V100: ```
#define OT_VO_LAYER_V0 0
``` **Solution Differences** <a name="table12167mcpsimp"></a>
...
<tbody><tr id="row12178mcpsimp"><td class="cellrowborder" valign="top" width="43%" headers="mcps1.1.3.1.1 "><p id="p12180mcpsimp"><a name="p12180mcpsimp"></a><a name="p12180mcpsimp"></a> /Hi3403V100<span xml:lang="x-NONE" id="ph12181mcpsimp"><a name="ph12181mcpsimp"></a><a name="ph12181mcpsimp"></a></span></p>
</td>
...
</table> **Notes** None. **Related Data Types and Interfaces** None. ## OT\_VO\_LAYER\_V1<a name="ZH-CN_TOPIC_0000002503965589"></a> **Description** Defines the layer number for video layer 1. **Definition** Hi3403V100: ```
#define OT_VO_LAYER_V1 1
``` **Solution Differences** <a name="table12197mcpsimp"></a>
...
<tbody><tr id="row12208mcpsimp"><td class="cellrowborder" valign="top" width="64%" headers="mcps1.1.3.1.1 "><p id="p12210mcpsimp"><a name="p12210mcpsimp"></a><a name="p12210mcpsimp"></a>Hi3403V100<span xml:lang="x-NONE" id="ph12211mcpsimp"><a name="ph12211mcpsimp"></a><a name="ph12211mcpsimp"></a></span></p>
</td>
...
</table> **Notes** None. **Related Data Types and Interfaces** None. ## OT\_VO\_LAYER\_V2<a name="ZH-CN_TOPIC_0000002504085507"></a> **Description** Defines the layer number for video layer 2. **Definition** Hi3403V100: ```
#define OT_VO_LAYER_V2 2
``` **Solution Differences** <a name="table12232mcpsimp"></a>
...
<tbody><tr id="row12243mcpsimp"><td class="cellrowborder" valign="top" width="76%" headers="mcps1.1.3.1.1 "><p id="p12245mcpsimp"><a name="p12245mcpsimp"></a><a name="p12245mcpsimp"></a> /Hi3403V100<span xml:lang="x-NONE" id="ph12246mcpsimp"><a name="ph12246mcpsimp"></a><a name="ph12246mcpsimp"></a></span></p>
</td>
...
</table> **Notes** None. **Related Data Types and Interfaces** None. ## OT\_VO\_LAYER\_V3<a name="ZH-CN_TOPIC_0000002503965669"></a> **Description** Defines the layer number for video layer 3. **Definition** : ```
#define OT_VO_LAYER_V3 3
``` **Solution Differences** <a name="table12262mcpsimp"></a>
...
</table> **Notes** None. **Related Data Types and Interfaces** None. ## OT\_VO\_LAYER\_G0<a name="ZH-CN_TOPIC_0000002504085511"></a> **Description** Defines the layer number for graphics layer 0. **Definition** : ```
#define OT_VO_LAYER_G0 4
``` Hi3403V100: ```
#define OT_VO_LAYER_G0 3
``` **Solution Differences** <a name="table12299mcpsimp"></a>
...
</table> **Notes** None. **Related Data Types and Interfaces** None. ## OT\_VO\_LAYER\_G1<a name="ZH-CN_TOPIC_0000002471085682"></a> **Description** Defines the layer number for graphics layer 1. **Definition** : ```
#define OT_VO_LAYER_G1 5
``` Hi3403V100: ```
#define OT_VO_LAYER_G1 4
``` **Solution Differences** <a name="table12336mcpsimp"></a>
...
</table> **Notes** None. **Related Data Types and Interfaces** None. ## OT\_VO\_LAYER\_G2<a name="ZH-CN_TOPIC_0000002504085597"></a> **Description** Defines the layer number for graphics layer 2. **Definition** : ```
#define OT_VO_LAYER_G2 6
``` **Solution Differences** <a name="table12376mcpsimp"></a>
...
</table> **Notes** None. **Related Data Types and Interfaces** None. ## OT\_VO\_LAYER\_G3<a name="ZH-CN_TOPIC_0000002503965585"></a> **Description** Defines the layer number for graphics layer 3. **Definition** : ```
#define OT_VO_LAYER_G3 7
``` Hi3403V100: ```
#define OT_VO_LAYER_G3 5
``` **Solution Differences** <a name="table12413mcpsimp"></a>
...
</table> **Notes** None. **Related Data Types and Interfaces** None. ## OT\_VO\_LAYER\_G4<a name="ZH-CN_TOPIC_0000002470925702"></a> **Description** Defines the layer number for graphics layer 4. **Definition** : ```
#define OT_VO_LAYER_G4 8
``` **Solution Differences** <a name="table12447mcpsimp"></a>
...
<tr id="row12463mcpsimp"><td class="cellrowborder" valign="top" width="35%" headers="mcps1.1.3.1.1 "><p id="p12465mcpsimp"><a name="p12465mcpsimp"></a><a name="p12465mcpsimp"></a><span xml:lang="x-NONE" id="ph12466mcpsimp"><a name="ph12466mcpsimp"></a><a name="ph12466mcpsimp"></a>/</span>Hi3403V100</p>
</td>
...
</table> **Notes** None. **Related Data Types and Interfaces** None. ## ot\_vo\_get\_virt\_layer<a name="ZH-CN_TOPIC_0000002504085529"></a> **Description** Defines the macro for obtaining the virtual video layer number corresponding to the virtual device. **Definition** : ```
...
``` **Solution Differences** <a name="table12485mcpsimp"></a>
...
</table> **Notes** None. **Related Data Types and Interfaces** None. ## ot\_vo\_get\_cas\_layer<a name="ZH-CN_TOPIC_0000002471085688"></a> **Description** Defines the macro for obtaining the cascade device video layer number corresponding to the cascade device. **Definition** : ```
#define ot_vo_get_cas_layer(vo_cas_device) ((vo_cas_device) + 5)
``` **Solution Differences** <a name="table12522mcpsimp"></a>
...
<tr id="row12538mcpsimp"><td class="cellrowborder" valign="top" width="41%" headers="mcps1.1.3.1.1 "><p id="p12540mcpsimp"><a name="p12540mcpsimp"></a><a name="p12540mcpsimp"></a>Hi3403V100</p>
</td>
...
</table> **Notes** None. **Related Data Types and Interfaces** None. ## OT\_VO\_MAX\_PRIORITY<a name="ZH-CN_TOPIC_0000002470925700"></a> **Description** Defines the maximum priority for Video Layers and Graphics Layers. **Definition** : ```
#define OT_VO_MAX_PRIORITY 4
``` Hi3403V100: ```
#define OT_VO_MAX_PRIORITY 3
``` **Solution Differences** <a name="table12557mcpsimp"></a>
...
</table> **Notes** None. **Related Data Types and Interfaces** None. ## OT\_VO\_MIN\_TOLERATE<a name="ZH-CN_TOPIC_0000002504085537"></a> **Description** Defines the minimum playback tolerance in milliseconds (ms). **Definition** ```
...
``` **Solution Differences** <a name="table12611mcpsimp"></a>
...
<tbody><tr id="row12622mcpsimp"><td class="cellrowborder" valign="top" width="48%" headers="mcps1.1.3.1.1 "><p id="p12624mcpsimp"><a name="p12624mcpsimp"></a><a name="p12624mcpsimp"></a>Hi3403V100</p>
</td>
...
</table> **Notes** When checking channel numbers in API interfaces, the maximum channel count OT_VO_MAX_CHN_NUM uses the values from the **Solution Differences** above. **Related Data Types and Interfaces** None. ## OT\_VO\_MIN\_CHN\_WIDTH<a name="ZH-CN_TOPIC_0000002504085561"></a> **Description** Defines the minimum channel width. **Definition** ```
...
``` **Solution Differences** <a name="table12717mcpsimp"></a>
...
<tr id="row12733mcpsimp"><td class="cellrowborder" valign="top" width="41%" headers="mcps1.1.3.1.1 "><p id="p12735mcpsimp"><a name="p12735mcpsimp"></a><a name="p12735mcpsimp"></a>Hi3403V100</p>
</td>
...
</table> **Notes** None. **Related Data Types and Interfaces** None. ## OT\_VO\_MAX\_CAS\_POS\_32RGN<a name="ZH-CN_TOPIC_0000002504085585"></a> **Description** Defines the maximum cascade position for 32 regions. **Definition** : ```
#define OT_VO_MAX_CAS_POS_32RGN 32
``` **Solution Differences** <a name="table12749mcpsimp"></a>
...
<tr id="row12765mcpsimp"><td class="cellrowborder" valign="top" width="41%" headers="mcps1.1.3.1.1 "><p id="p12767mcpsimp"><a name="p12767mcpsimp"></a><a name="p12767mcpsimp"></a>Hi3403V100</p>
</td>
...
</table> **Notes** None. **Related Data Types and Interfaces** None. ## OT\_VO\_MAX\_CAS\_POS\_64RGN<a name="ZH-CN_TOPIC_0000002503965681"></a> **Description** Defines the maximum cascade position for 64 regions. **Definition** : ```
#define OT_VO_MAX_CAS_POS_64RGN 64
``` **Solution Differences** <a name="table12781mcpsimp"></a>
...
<tr id="row12797mcpsimp"><td class="cellrowborder" valign="top" width="41%" headers="mcps1.1.3.1.1 "><p id="p12799mcpsimp"><a name="p12799mcpsimp"></a><a name="p12799mcpsimp"></a>Hi3403V100</p>
</td>
...
</table> **Notes** None. **Related Data Types and Interfaces** None. ## ot\_vo\_device<a name="ZH-CN_TOPIC_0000002470925690"></a> **Description** Defines the Device number. **Definition** ```
typedef td_s32 ot_vo_device;
``` **Members** <a name="table12812mcpsimp"></a>
...
</table> **Solution Differences** None. **Notes** None. **Related Data Types and Interfaces** [ot\_vo\_pub\_attr](#ot_vo_pub_attr) ## ot\_vo\_layer<a name="ZH-CN_TOPIC_0000002504085573"></a> **Description** Defines the Video Layer number. **Definition** ```
typedef td_s32 ot_vo_layer;
``` **Members** <a name="table12858mcpsimp"></a>
...
</table> **Solution Differences** <a name="table12919mcpsimp"></a>
...
<td class="cellrowborder" valign="top" width="64%" headers="mcps1.1.3.1.2 "><p id="p12934mcpsimp"><a name="p12934mcpsimp"></a><a name="p12934mcpsimp"></a>V0/V1/V3/G0/G1 video layers and graphics layers are fixedly bound to the corresponding devices, PIP video layer V2 can be bound to device DHD0or DHD1 , Mouse layer G2 can be bound to device DHD0/DHD1/DSD0 , Graphics layer G3 can be bound to device DHD0/DHD1/DSD0.</p>
</td>
</tr>
</td>
<td class="cellrowborder" valign="top" width="64%" headers="mcps1.1.3.1.2 "><p id="p12939mcpsimp"><a name="p12939mcpsimp"></a><a name="p12939mcpsimp"></a>V0/V3/G0 video layers and graphics layers are fixedly bound to the corresponding devices, PIP video layer V2 can be bound to device DHD0 , Mouse layer G2 can be bound to device DHD0/DSD0 , Graphics layer G3 can be bound to device DHD0/DSD0.</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="64%" headers="mcps1.1.3.1.2 "><p id="p12944mcpsimp"><a name="p12944mcpsimp"></a><a name="p12944mcpsimp"></a>V0/V1/G0/G1 video layers and graphics layers are fixedly bound to the corresponding devices, PIP video layer V2 can be bound to device DHD0or DHD1 , Graphics layer G3 can be bound to device DHD0/DHD1.</p>
</td>
</tr>
</td>
<td class="cellrowborder" valign="top" width="64%" headers="mcps1.1.3.1.2 "><p id="p12949mcpsimp"><a name="p12949mcpsimp"></a><a name="p12949mcpsimp"></a>V0/V1/G0/G1 video layers and graphics layers are fixedly bound to the corresponding devices, PIP video layer V2 can be bound to device DHD0or DHD1 , V3 can be bound to DHD1or DSD0 , Mouse layer G2 can be bound to device DHD0/DHD1/DSD0 , Graphics layer G3 can be bound to device DHD0/DHD1 , Graphics layer G4 can be bound to device DHD1/ DSD0.</p>
...
</table> **Notes** None. **Related Data Types and Interfaces** [ot\_vo\_video\_layer\_attr](#ot_vo_video_layer_attr) ## ot\_vo\_chn<a name="ZH-CN_TOPIC_0000002503965655"></a> **Description** Defines the Channel number. **Definition** ```
typedef td_s32 ot_vo_chn;
``` **Solution Differences** None. **Notes** None. **Related Data Types and Interfaces** [ot\_vo\_chn\_attr](#ot_vo_chn_attr) ## ot\_vo\_wbc<a name="ZH-CN_TOPIC_0000002471085640"></a> **Description** Defines the write-back channel number. **Definition** ```
typedef td_s32 ot_vo_wbc;
``` **Members** <a name="table12974mcpsimp"></a>
...
</table> **Notes** None. **Related Data Types and Interfaces** ss\_mpi\_vo\_enable\_wbc ## ot\_vo\_intf\_type<a name="ZH-CN_TOPIC_0000002471085652"></a> **Description** Defines the interface type. **Definition** ```
...
typedef enum { OT_VO_OUT_PAL = 0, OT_VO_OUT_NTSC = 1, OT_VO_OUT_960H_PAL = 2, OT_VO_OUT_960H_NTSC = 3, OT_VO_OUT_640x480_60 = 4, OT_VO_OUT_480P60 = 5, OT_VO_OUT_576P50 = 6, OT_VO_OUT_800x600_60 = 7, OT_VO_OUT_1024x768_60 = 8, OT_VO_OUT_720P50 = 9, OT_VO_OUT_720P60 = 10, OT_VO_OUT_1280x800_60 = 11, OT_VO_OUT_1280x1024_60 = 12, OT_VO_OUT_1366x768_60 = 13, OT_VO_OUT_1400x1050_60 = 14, OT_VO_OUT_1440x900_60 = 15, OT_VO_OUT_1680x1050_60 = 16, OT_VO_OUT_1080P24 = 17, OT_VO_OUT_1080P25 = 18, OT_VO_OUT_1080P30 = 19, OT_VO_OUT_1080I50 = 20, OT_VO_OUT_1080I60 = 21, OT_VO_OUT_1080P50 = 22, OT_VO_OUT_1080P60 = 23, OT_VO_OUT_1600x1200_60 = 24, OT_VO_OUT_1920x1200_60 = 25, OT_VO_OUT_1920x2160_30 = 26, OT_VO_OUT_2560x1440_30 = 27, OT_VO_OUT_2560x1440_60 = 28, OT_VO_OUT_2560x1600_60 = 29, OT_VO_OUT_3840x2160_24 = 30, OT_VO_OUT_3840x2160_25 = 31, OT_VO_OUT_3840x2160_30 = 32, OT_VO_OUT_3840x2160_50 = 33, OT_VO_OUT_3840x2160_60 = 34, OT_VO_OUT_4096x2160_24 = 35, OT_VO_OUT_4096x2160_25 = 36, OT_VO_OUT_4096x2160_30 = 37, OT_VO_OUT_4096x2160_50 = 38, OT_VO_OUT_4096x2160_60 = 39, OT_VO_OUT_7680x4320_30 = 40, OT_VO_OUT_240x320_50 = 41, OT_VO_OUT_320x240_50 = 42, OT_VO_OUT_240x320_60 = 43, OT_VO_OUT_320x240_60 = 44, OT_VO_OUT_800x600_50 = 45, OT_VO_OUT_720x1280_60 = 46, OT_VO_OUT_1080x1920_60 = 47, OT_VO_OUT_USER = 48, OT_VO_OUT_BUTT,
} ot_vo_intf_sync;
...
typedef struct { td_bool syncm; td_bool iop; td_u8 intfb; td_u16 vact; td_u16 vbb; td_u16 vfb; td_u16 hact; td_u16 hbb; td_u16 hfb; td_u16 hmid; td_u16 bvact; td_u16 bvbb; td_u16 bvfb; td_u16 hpw; td_u16 vpw; td_bool idv; td_bool ihs; td_bool ivs;
} ot_vo_sync_info;
``` **Members** <a name="_Ref27574376"></a>
...
</table> **Figure 1** Timing Information Structure Schematic Diagram<a name="fig1542613311207"></a> ![](figures/Timing Informationshownmeaninggraph.png "Timing Informationshownmeaninggraph") **Table 1** Timing Pixel Clock Calculation Formula <a name="table13230mcpsimp"></a>
...
<th class="cellrowborder" valign="top" width="86%" id="mcps1.2.3.1.2"><p id="p13240mcpsimp"><a name="p13240mcpsimp"></a><a name="p13240mcpsimp"></a>Calculation Formula (M Hz)</p>
</th>
</tr>
</thead>
...
</table> **Notes** - As shown in [Figure1](#fig1542613311207), when configuring the blanking area, the horizontal back porch hbb already includes the width hpw of the horizontal sync signal; the vertical back porch vbb already includes the height vpw of the vertical sync signal (for interlaced, the bottom field vertical back porch bvbb already includes vpw).
- Only the following parameter checks are performed internally: - hact, hbb, hfb, vbb, vfb, hpw, vpwmust not be 0. - vactmust be greater than or equal to 100. - idv, ihs, ivscan only be TD_TRUE or TD_FALSE. - When iop is TD_FALSE, bvact, bvbb, and bvfb must not be 0. The user must ensure the timing configuration is correct. **Related Data Types and Interfaces** ss\_mpi\_vo\_set\_pub\_attr ## ot\_vo\_pub\_attr<a name="ZH-CN_TOPIC_0000002470925730"></a> **Description** Defines the public attribute structure for video output. **Definition** ```
typedef struct { td_u32 bg_color; ot_vo_intf_type intf_type; ot_vo_intf_sync intf_sync; ot_vo_sync_info sync_info;
} ot_vo_pub_attr;
``` **Members** <a name="table13279mcpsimp"></a>
...
</table> **Notes** - The interface type of virtual devices is an unused parameter and is not checked. Supported timings for virtual devices:\[OT\_VO\_OUT\_PAL, OT\_VO\_OUT\_USER\].
...
</table> **Table 2** Interface Supported Timing Range <a name="_Ref21975484"></a>
...
</table> **Table 3** Mutually Exclusive Interface List <a name="_Ref66804759"></a>
...
</table> **Related Data Types and Interfaces** ss\_mpi\_vo\_set\_pub\_attr ## ot\_vo\_device\_param<a name="ZH-CN_TOPIC_0000002504085543"></a> **Description** Defines the VO video output device parameter structure, used to configure the VO pass-through flag. **Definition** ```
typedef struct { td_bool vo_bypass_en;
} ot_vo_device_param;
``` **Members** <a name="table13850mcpsimp"></a>
...
</table> **Notes** None **Related Data Types and Interfaces** ss\_mpi\_vo\_set\_device\_param ## ot\_vo\_mod\_param<a name="ZH-CN_TOPIC_0000002503965643"></a> **Description** VO Module Parameter. **Definition** ```
typedef struct { td_bool exit_device_en; td_bool device_clk_ext_en; td_bool vga_detect_en; td_u32 vdac_detect_cycle; td_bool cal_cost_time_en;
} ot_vo_mod_param;
``` **Members** <a name="table13883mcpsimp"></a>
...
</table> **Difference Description** <a name="table13924mcpsimp"></a>
...
</table> **Notes** - exit\_device\_en indicates whether to disable the VO device when exiting VO via ss\_mpi\_sys\_exit (see the "System Control" chapter). **Related Data Types and Interfaces** None. ## ot\_vo\_clk\_src<a name="ZH-CN_TOPIC_0000002470925708"></a> **Description** VO device clock source type. **Definition** ```
typedef enum { OT_VO_CLK_SRC_PLL = 0, OT_VO_CLK_SRC_LCDMCLK = 1, OT_VO_CLK_SRC_PLL_FOUT4 = 2, OT_VO_CLK_SRC_FIXED = 3, OT_VO_CLK_SRC_BUTT,
} ot_vo_clk_src;
``` **Members** <a name="table13970mcpsimp"></a>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.1.3.1.2 "><p id="p13985mcpsimp"><a name="p13985mcpsimp"></a><a name="p13985mcpsimp"></a>PLL-type clock source (from PLL <strong id="b13986mcpsimp"><a name="b13986mcpsimp"></a><a name="b13986mcpsimp"></a>FOUTPOSTDIV pin output</strong>), reference range: [16.326531, 594]M Hz.</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.1.3.1.2 "><p id="p13991mcpsimp"><a name="p13991mcpsimp"></a><a name="p13991mcpsimp"></a>LCD divider clock source, reference range: (0, 75]M Hz.</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.1.3.1.2 "><p id="p13996mcpsimp"><a name="p13996mcpsimp"></a><a name="p13996mcpsimp"></a>PLL FOUT4-type clock source (from PLL <strong id="b13997mcpsimp"><a name="b13997mcpsimp"></a><a name="b13997mcpsimp"></a>FOUT4 pin output</strong>), reference range: [2.040817, 594]M Hz.</p>
</td>
</tr>
...
</table> **Notes** Clock source characteristics notes: - Frequency: PLL-type clock sources can output higher frequencies, suitable for large timings such as 1080P60 and 3840x2160_60. LCD divider clock sources and PLL FOUT4-type clock sources can output lower frequencies, suitable for small-to-medium LCD screen timings.
- Frequency accuracy: LCD divider clock sources may experience frequency jitter and instability. When stable frequency or timing output is required, if the desired frequency is supported, consider using a fixed frequency type clock source. **Related Data Types and Interfaces** None. ## ot\_vo\_fixed\_clk<a name="ZH-CN_TOPIC_0000002470925722"></a> **Description** VO fixed clock frequency type. **Definition** ```
typedef enum { OT_VO_FIXED_CLK_148_5M = 0, OT_VO_FIXED_CLK_134_4M = 1, OT_VO_FIXED_CLK_108M = 2, OT_VO_FIXED_CLK_74_25M = 3, OT_VO_FIXED_CLK_64M = 4, OT_VO_FIXED_CLK_54M = 5, OT_VO_FIXED_CLK_37_125M = 6, OT_VO_FIXED_CLK_13_5M = 7, OT_VO_FIXED_CLK_BUTT,
} ot_vo_fixed_clk;
``` **Members** <a name="table14030mcpsimp"></a>
...
<td class="cellrowborder" valign="top" width="52%" headers="mcps1.1.3.1.2 "><p id="p14045mcpsimp"><a name="p14045mcpsimp"></a><a name="p14045mcpsimp"></a>Fixed clock frequency: 148.5M Hz.</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="52%" headers="mcps1.1.3.1.2 "><p id="p14050mcpsimp"><a name="p14050mcpsimp"></a><a name="p14050mcpsimp"></a>Fixed clock frequency: 134.4M Hz.</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="52%" headers="mcps1.1.3.1.2 "><p id="p14055mcpsimp"><a name="p14055mcpsimp"></a><a name="p14055mcpsimp"></a>Fixed clock frequency: 108M Hz.</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="52%" headers="mcps1.1.3.1.2 "><p id="p14060mcpsimp"><a name="p14060mcpsimp"></a><a name="p14060mcpsimp"></a>Fixed clock frequency: 74.25M Hz.</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="52%" headers="mcps1.1.3.1.2 "><p id="p14065mcpsimp"><a name="p14065mcpsimp"></a><a name="p14065mcpsimp"></a>Fixed clock frequency: 64M Hz.</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="52%" headers="mcps1.1.3.1.2 "><p id="p14070mcpsimp"><a name="p14070mcpsimp"></a><a name="p14070mcpsimp"></a>Fixed clock frequency: 54M Hz.</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="52%" headers="mcps1.1.3.1.2 "><p id="p14075mcpsimp"><a name="p14075mcpsimp"></a><a name="p14075mcpsimp"></a>Fixed clock frequency: 37.125M Hz.</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="52%" headers="mcps1.1.3.1.2 "><p id="p14080mcpsimp"><a name="p14080mcpsimp"></a><a name="p14080mcpsimp"></a>Fixed clock frequency: 13.5M Hz.</p>
</td>
</tr>
</tbody>
</table> **Notes** None **Related Data Types and Interfaces** None. ## ot\_vo\_pll<a name="ZH-CN_TOPIC_0000002471085706"></a> **Description** User interface timing PLL information, used to configure PLL. **Definition** ```
typedef struct { td_u32 fb_div; td_u32 frac; td_u32 ref_div; td_u32 post_div1; td_u32 post_div2;
} ot_vo_pll;
``` **Members** <a name="table14098mcpsimp"></a>
...
</table> **Solution Differences** <a name="table14135mcpsimp"></a>
...
<tr id="row14151mcpsimp"><td class="cellrowborder" valign="top" width="50%" headers="mcps1.1.3.1.1 "><p id="p14153mcpsimp"><a name="p14153mcpsimp"></a><a name="p14153mcpsimp"></a>Hi3403V100</p>
</td>
...
</table> **Notes** - This data item is only used to configure the **Members** table coefficients.
...
2. Confirm the PLL output pin to VO. For the specific PLL clock source calculation method and pins, refer to the "PLL Frequency Calculation Method" section in the System chapter of the corresponding chip manual. **Table 1** PLL and PLL FOUT4 Frequency Calculation Method ( Example) <a name="_Ref27641630"></a> <table><thead align="left"><tr id="row14178mcpsimp"><th class="cellrowborder" valign="top" width="24.752475247524757%" id="mcps1.2.4.1.1"><p id="p14180mcpsimp"><a name="p14180mcpsimp"></a><a name="p14180mcpsimp"></a>PLL Pin</p> </th> <th class="cellrowborder" valign="top" width="37.62376237623762%" id="mcps1.2.4.1.2"><p id="p14182mcpsimp"><a name="p14182mcpsimp"></a><a name="p14182mcpsimp"></a>Calculation Method Description</p> </th> <th class="cellrowborder" valign="top" width="37.62376237623762%" id="mcps1.2.4.1.3"><p id="p14184mcpsimp"><a name="p14184mcpsimp"></a><a name="p14184mcpsimp"></a>Notes</p> </th> </tr> </thead> <tbody><tr id="row14186mcpsimp"><td class="cellrowborder" valign="top" width="24.752475247524757%" headers="mcps1.2.4.1.1 "><p id="p14188mcpsimp"><a name="p14188mcpsimp"></a><a name="p14188mcpsimp"></a>FREF</p> </td> <td class="cellrowborder" valign="top" width="37.62376237623762%" headers="mcps1.2.4.1.2 "><p id="p14190mcpsimp"><a name="p14190mcpsimp"></a><a name="p14190mcpsimp"></a>PLL Input reference clock</p> </td> <td class="cellrowborder" valign="top" width="37.62376237623762%" headers="mcps1.2.4.1.3 "><p id="p14192mcpsimp"><a name="p14192mcpsimp"></a><a name="p14192mcpsimp"></a> Requires fixed input of 24M Hz</p> </td> </tr> <tr id="row14193mcpsimp"><td class="cellrowborder" valign="top" width="24.752475247524757%" headers="mcps1.2.4.1.1 "><p id="p14195mcpsimp"><a name="p14195mcpsimp"></a><a name="p14195mcpsimp"></a>FOUTVCO</p> </td> <td class="cellrowborder" valign="top" width="37.62376237623762%" headers="mcps1.2.4.1.2 "><p id="p14197mcpsimp"><a name="p14197mcpsimp"></a><a name="p14197mcpsimp"></a>FREF x ( fb_div + frac/ 2^24) / ref_div</p> </td> <td class="cellrowborder" valign="top" width="37.62376237623762%" headers="mcps1.2.4.1.3 "><p id="p14199mcpsimp"><a name="p14199mcpsimp"></a><a name="p14199mcpsimp"></a>PLL operating frequency, must be >= 800M Hz, and <= 3.2G Hz</p> </td> </tr> <tr id="row14200mcpsimp"><td class="cellrowborder" valign="top" width="24.752475247524757%" headers="mcps1.2.4.1.1 "><p id="p14202mcpsimp"><a name="p14202mcpsimp"></a><a name="p14202mcpsimp"></a>FOUTVCO2X</p> </td> <td class="cellrowborder" valign="top" width="37.62376237623762%" headers="mcps1.2.4.1.2 "><p id="p14204mcpsimp"><a name="p14204mcpsimp"></a><a name="p14204mcpsimp"></a>FOUTVCO * 2</p> </td> <td class="cellrowborder" valign="top" width="37.62376237623762%" headers="mcps1.2.4.1.3 "><p id="p14206mcpsimp"><a name="p14206mcpsimp"></a><a name="p14206mcpsimp"></a>-</p> </td> </tr> <tr id="row14207mcpsimp"><td class="cellrowborder" valign="top" width="24.752475247524757%" headers="mcps1.2.4.1.1 "><p id="p14209mcpsimp"><a name="p14209mcpsimp"></a><a name="p14209mcpsimp"></a>FOUTPOSTDIV</p> </td> <td class="cellrowborder" valign="top" width="37.62376237623762%" headers="mcps1.2.4.1.2 "><p id="p14211mcpsimp"><a name="p14211mcpsimp"></a><a name="p14211mcpsimp"></a>FOUTVCO / (post_div1 x post_div2)</p> </td> <td class="cellrowborder" valign="top" width="37.62376237623762%" headers="mcps1.2.4.1.3 "><p id="p14213mcpsimp"><a name="p14213mcpsimp"></a><a name="p14213mcpsimp"></a>post_div1 &gt;= post_div2</p> </td> </tr> <tr id="row14214mcpsimp"><td class="cellrowborder" valign="top" width="24.752475247524757%" headers="mcps1.2.4.1.1 "><p id="p14216mcpsimp"><a name="p14216mcpsimp"></a><a name="p14216mcpsimp"></a>FOUT1PH0</p> </td> <td class="cellrowborder" valign="top" width="37.62376237623762%" headers="mcps1.2.4.1.2 "><p id="p14218mcpsimp"><a name="p14218mcpsimp"></a><a name="p14218mcpsimp"></a>FOUTVCO / (post_div1 x post_div2 x 2)</p> </td> <td class="cellrowborder" valign="top" width="37.62376237623762%" headers="mcps1.2.4.1.3 "><p id="p14220mcpsimp"><a name="p14220mcpsimp"></a><a name="p14220mcpsimp"></a>-</p> </td> </tr> <tr id="row14221mcpsimp"><td class="cellrowborder" valign="top" width="24.752475247524757%" headers="mcps1.2.4.1.1 "><p id="p14223mcpsimp"><a name="p14223mcpsimp"></a><a name="p14223mcpsimp"></a>FOUT2</p> </td> <td class="cellrowborder" valign="top" width="37.62376237623762%" headers="mcps1.2.4.1.2 "><p id="p14225mcpsimp"><a name="p14225mcpsimp"></a><a name="p14225mcpsimp"></a>FOUTVCO / (post_div1 x post_div2 x 4)</p> </td> <td class="cellrowborder" valign="top" width="37.62376237623762%" headers="mcps1.2.4.1.3 "><p id="p14227mcpsimp"><a name="p14227mcpsimp"></a><a name="p14227mcpsimp"></a>-</p> </td> </tr> <tr id="row14228mcpsimp"><td class="cellrowborder" valign="top" width="24.752475247524757%" headers="mcps1.2.4.1.1 "><p id="p14230mcpsimp"><a name="p14230mcpsimp"></a><a name="p14230mcpsimp"></a>FOUT3</p> </td> <td class="cellrowborder" valign="top" width="37.62376237623762%" headers="mcps1.2.4.1.2 "><p id="p14232mcpsimp"><a name="p14232mcpsimp"></a><a name="p14232mcpsimp"></a>FOUTVCO / (post_div1 x post_div2 x 6)</p> </td> <td class="cellrowborder" valign="top" width="37.62376237623762%" headers="mcps1.2.4.1.3 "><p id="p14234mcpsimp"><a name="p14234mcpsimp"></a><a name="p14234mcpsimp"></a>-</p> </td> </tr> <tr id="row14235mcpsimp"><td class="cellrowborder" valign="top" width="24.752475247524757%" headers="mcps1.2.4.1.1 "><p id="p14237mcpsimp"><a name="p14237mcpsimp"></a><a name="p14237mcpsimp"></a>FOUT4</p> </td> <td class="cellrowborder" valign="top" width="37.62376237623762%" headers="mcps1.2.4.1.2 "><p id="p14239mcpsimp"><a name="p14239mcpsimp"></a><a name="p14239mcpsimp"></a>FOUTVCO / (post_div1 x post_div2 x 8)</p> </td> <td class="cellrowborder" valign="top" width="37.62376237623762%" headers="mcps1.2.4.1.3 "><p id="p14241mcpsimp"><a name="p14241mcpsimp"></a><a name="p14241mcpsimp"></a>post_div1 &gt;= post_div2</p> </td> </tr> </tbody> </table> For example, to configure the PLL clock source to output 600M Hz as an example, target is 600M Hz. - Confirm the PLL output pin to VO: FOUTPOSTDIV, i.e., FOUTPOSTDIV=600M Hz. - Configure FOUTPOSTDIV as FOUTVCO half, based on FOUTPOSTDIV= FOUTVCO / \(post\_div1 x post\_div2\), post\_div2=1, post\_div1=2. - Configure FOUTVCO to output 1200MHz, based on FREF x \( fb\_div + frac/ 2^24\) / ref\_div = 1200MHz, where FREF = 24MHz, if ref\_div = 1, calculate fb\_div = 50, frac = 0 1. Fill in the values from **Step 2**, calculate fb\_div, frac, ref\_div, post\_div1, post\_div2 and ot\_vo\_pll, then use the interface ss\_mpi\_vo\_set\_user\_sync\_info to configure the PLL. **Related Data Types and Interfaces** [ot\_vo\_user\_sync\_info](#ot_vo_user_sync_info) ## ot\_vo\_user\_sync\_attr<a name="ZH-CN_TOPIC_0000002470925672"></a> **Description** User interface timing attributes, including configuration information for clock source type and clock frequency (the output frequency of the clock source, src_clk). **Definition** ```
typedef struct { ot_vo_clk_src clk_src; union { ot_vo_pll vo_pll; td_u32 lcd_m_clk_div; ot_vo_fixed_clk fixed_clk; };
} ot_vo_user_sync_attr;
``` **Members** <a name="table14273mcpsimp"></a>
...
</table> **Solution Differences** <a name="table14311mcpsimp"></a>
...
<p id="p14329mcpsimp"><a name="p14329mcpsimp"></a><a name="p14329mcpsimp"></a>DSD0: Fixed clock source 54M Hz, not configurable.</p>
</td>
</tr>
</td>
...
<p id="p14336mcpsimp"><a name="p14336mcpsimp"></a><a name="p14336mcpsimp"></a>DSD0: Fixed clock source 54M Hz, not configurable.</p>
</td>
</tr>
...
</table> **Notes** If the clock source is of PLL or PLL FOUT4 type, see the PLL and PLL FOUT4 Frequency Calculation Method ( Example) table for the frequency calculation method. If it is an LCD divider type clock source, see the LCDMCLK Division Factor lcd\_m\_clk\_div Calculation Method table for the lcd\_m\_clk\_div calculation method. **Table 1** LCDMCLK Division Factor lcd\_m\_clk\_div Calculation Method <a name="_Ref27676820"></a>
...
</table> **Table 2** Clock Source Frequency Configuration Method <a name="_Ref18008712"></a>
...
</table> Note: pixel\_clk represents the Pixel Clock frequency of the timing. See [ot\_vo\_user\_sync\_info](#ZH-CN_TOPIC_0000002503965651) for device\_div and pre\_div. - The vo\_pll member in the union is valid only when the clk\_src member is OT\_VO\_CLK\_SRC\_PLL or OT\_VO\_CLK\_SRC\_PLL\_FOUT4.
...
- lcd\_m\_clk\_div range: \(0, 8473341\]. **Related Data Types and Interfaces** [ot\_vo\_user\_sync\_info](#ot_vo_user_sync_info) ## ot\_vo\_user\_sync\_info<a name="ZH-CN_TOPIC_0000002503965651"></a> **Description** User interface timing information, including configuration for clock source type, clock frequency, clock divider ratio, and clock phase. See the Pixel Clock Simplified Schematic Diagram for the topology relationship. **Figure 1** Pixel Clock Simplified Schematic Diagram<a name="fig82411535184119"></a> ![](figures/Pixelwhenneedshownmeaninggraph.png "Pixelwhenneedshownmeaninggraph") **Definition** ```
...
``` **Members** <a name="table14506mcpsimp"></a>
...
</table> **Notes** The device clock divider ratio is related to **Solution**, device, and interface. See the Clock Divider Ratio Configuration Method table for the recommended configuration method. **Table 1** Clock Divider Ratio Configuration Method <a name="_Ref18008737"></a>
...
</table> - The device pre-divider attribute needs to be configured only when uses HDMI (including HDMI same-source) interface output. For other interface outputs, the pre-divider attribute is configured as 1 (no division). For Hi3403V100, the pre-divider attribute must be configured as 1 (no division) for all interfaces. Therefore, as can be seen from [Figure 1](#fig82411535184119), for the same timing, HDMI interface (including HDMI same-source) output and non-HDMI interface output require two different sets of clock source parameters. Configure the pre-divider attribute value based on the Pixel Clock frequency range. Due to the existence of the pre-divider, the PLL clock must be configured with a correspondingly increased multiplier. **Table 2** Pre-divider Configuration Method <a name="_Ref28616410"></a>
...
<p id="p159191254818"><a name="p159191254818"></a><a name="p159191254818"></a></p>
</td>
...
<tr id="row20506173711478"><td class="cellrowborder" valign="top" width="20.1%" headers="mcps1.2.5.1.1 "><p xml:lang="fr-FR" id="p52631619194817"><a name="p52631619194817"></a><a name="p52631619194817"></a>Hi3403V100</p>
</td>
...
</table> - The clock phase inversion clk\_reverse\_en can be configured according to the requirements of the external device, and only takes effect for BT.1120/BT.656/RGB interfaces. The default configuration under non-user timing is shown in the clk\_reverse\_en Default Configuration table. **Table 3** clk\_reverse\_en Default Configuration <a name="_Ref69291387"></a>
...
</table> - The following is the user timing information derivation method **Table 4** User Timing Information Derivation Method <a name="table14749mcpsimp"></a>
...
<td class="cellrowborder" valign="top" width="64%" headers="mcps1.2.3.1.2 "><p id="p14765mcpsimp"><a name="p14765mcpsimp"></a><a name="p14765mcpsimp"></a>Take -DHD0-HDMI-1080P60 as an example.</p>
</td>
</tr>
...
</table> **Related Data Types and Interfaces** [ot\_vo\_user\_sync\_attr](#ot_vo_user_sync_attr) ## ot\_vo\_less\_buf\_attr<a name="ZH-CN_TOPIC_0000002471085718"></a> **Description** VO module buffer-saving attribute parameters. **Definition** ```
typedef struct { td_bool enable; td_u32 vtth;
} ot_vo_less_buf_attr;
``` **Members** <a name="table14896mcpsimp"></a>
...
</table> **Notes** None. **Related Data Types and Interfaces** None. ## ot\_vo\_user\_notify\_attr<a name="ZH-CN_TOPIC_0000002503965617"></a> **Description** VO module user notification attribute parameters. **Definition** ```
typedef struct { td_bool enable; td_u32 vtth;
} ot_vo_user_notify_attr;
``` **Members** <a name="table54719208301"></a>
...
</table> **Notes** None **Related Data Types and Interfaces** None ## ot\_vo\_intf\_plug\_status<a name="ZH-CN_TOPIC_0000002503965627"></a> **Description** Defines the VGA/CVBS interface connection status type. **Definition** ```
typedef enum { OT_VO_INTF_STATUS_NO_PLUG = 0, OT_VO_INTF_STATUS_PLUG = 1, OT_VO_INTF_STATUS_BUTT,
} ot_vo_intf_plug_status;
``` **Members** <a name="table14946mcpsimp"></a>
...
</table> **Notes** None **Related Data Types and Interfaces** ss\_mpi\_vo\_query\_intf\_status ## ot\_vo\_intf\_status<a name="ZH-CN_TOPIC_0000002471085630"></a> **Description** Defines the VGA/CVBS interface status structure. **Definition** ```
typedef struct { ot_vo_intf_plug_status plug_status;
} ot_vo_intf_status;
``` **Members** <a name="table14988mcpsimp"></a>
...
<td class="cellrowborder" valign="top" width="59%" headers="mcps1.1.3.1.2 "><p id="p15060mcpsimp"><a name="p15060mcpsimp"></a><a name="p15060mcpsimp"></a>BT.601 LIMIT to BT.601 LIMIT Color Space CSC matrix.</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="59%" headers="mcps1.1.3.1.2 "><p id="p15065mcpsimp"><a name="p15065mcpsimp"></a><a name="p15065mcpsimp"></a>BT.601 FULL to BT.601 LIMIT Color Space CSC matrix.</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="59%" headers="mcps1.1.3.1.2 "><p id="p15070mcpsimp"><a name="p15070mcpsimp"></a><a name="p15070mcpsimp"></a>BT.709 LIMIT to BT.601 LIMIT Color Space CSC matrix.</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="59%" headers="mcps1.1.3.1.2 "><p id="p15075mcpsimp"><a name="p15075mcpsimp"></a><a name="p15075mcpsimp"></a>BT.709 FULL to BT.601 LIMIT Color Space CSC matrix.</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="59%" headers="mcps1.1.3.1.2 "><p id="p15080mcpsimp"><a name="p15080mcpsimp"></a><a name="p15080mcpsimp"></a>BT.601 LIMIT to BT.709 LIMIT Color Space CSC matrix.</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="59%" headers="mcps1.1.3.1.2 "><p id="p15085mcpsimp"><a name="p15085mcpsimp"></a><a name="p15085mcpsimp"></a>BT.601 FULL to BT.709 LIMIT Color Space CSC matrix.</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="59%" headers="mcps1.1.3.1.2 "><p id="p15090mcpsimp"><a name="p15090mcpsimp"></a><a name="p15090mcpsimp"></a>BT.709 LIMIT to BT.709 LIMIT Color Space CSC matrix.</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="59%" headers="mcps1.1.3.1.2 "><p id="p15095mcpsimp"><a name="p15095mcpsimp"></a><a name="p15095mcpsimp"></a>BT.709 FULL to BT.709 LIMIT Color Space CSC matrix.</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="59%" headers="mcps1.1.3.1.2 "><p id="p15100mcpsimp"><a name="p15100mcpsimp"></a><a name="p15100mcpsimp"></a>BT.601 LIMIT to BT.601 FULL Color Space CSC matrix.</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="59%" headers="mcps1.1.3.1.2 "><p id="p15105mcpsimp"><a name="p15105mcpsimp"></a><a name="p15105mcpsimp"></a>BT.601 FULL to BT.601 FULL Color Space CSC matrix.</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="59%" headers="mcps1.1.3.1.2 "><p id="p15110mcpsimp"><a name="p15110mcpsimp"></a><a name="p15110mcpsimp"></a>BT.709 LIMIT to BT.601 FULL Color Space CSC matrix.</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="59%" headers="mcps1.1.3.1.2 "><p id="p15115mcpsimp"><a name="p15115mcpsimp"></a><a name="p15115mcpsimp"></a>BT.709 FULL to BT.601 FULL Color Space CSC matrix.</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="59%" headers="mcps1.1.3.1.2 "><p id="p15120mcpsimp"><a name="p15120mcpsimp"></a><a name="p15120mcpsimp"></a>BT.601 LIMIT to BT.709 FULL Color Space CSC matrix.</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="59%" headers="mcps1.1.3.1.2 "><p id="p15125mcpsimp"><a name="p15125mcpsimp"></a><a name="p15125mcpsimp"></a>BT.601 FULL to BT.709 FULL Color Space CSC matrix.</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="59%" headers="mcps1.1.3.1.2 "><p id="p15130mcpsimp"><a name="p15130mcpsimp"></a><a name="p15130mcpsimp"></a>BT.709 LIMIT to BT.709 FULL Color Space CSC matrix.</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="59%" headers="mcps1.1.3.1.2 "><p id="p15135mcpsimp"><a name="p15135mcpsimp"></a><a name="p15135mcpsimp"></a>BT.709 FULL to BT.709 FULL Color Space CSC matrix.</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="59%" headers="mcps1.1.3.1.2 "><p id="p15140mcpsimp"><a name="p15140mcpsimp"></a><a name="p15140mcpsimp"></a>BT.601 LIMIT to RGB FULL Color Space CSC matrix.</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="59%" headers="mcps1.1.3.1.2 "><p id="p15145mcpsimp"><a name="p15145mcpsimp"></a><a name="p15145mcpsimp"></a>BT.601 FULL to RGB FULL Color Space CSC matrix.</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="59%" headers="mcps1.1.3.1.2 "><p id="p15150mcpsimp"><a name="p15150mcpsimp"></a><a name="p15150mcpsimp"></a>BT.709 LIMIT to RGB FULL Color Space CSC matrix.</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="59%" headers="mcps1.1.3.1.2 "><p id="p15155mcpsimp"><a name="p15155mcpsimp"></a><a name="p15155mcpsimp"></a>BT.709 FULL to RGB FULL Color Space CSC matrix.</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="59%" headers="mcps1.1.3.1.2 "><p id="p15160mcpsimp"><a name="p15160mcpsimp"></a><a name="p15160mcpsimp"></a>BT.601 LIMIT to RGB LIMIT Color Space CSC matrix.</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="59%" headers="mcps1.1.3.1.2 "><p id="p15165mcpsimp"><a name="p15165mcpsimp"></a><a name="p15165mcpsimp"></a>BT.601 FULL to RGB LIMIT Color Space CSC matrix.</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="59%" headers="mcps1.1.3.1.2 "><p id="p15170mcpsimp"><a name="p15170mcpsimp"></a><a name="p15170mcpsimp"></a>BT.709 LIMIT to RGB LIMIT Color Space CSC matrix.</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="59%" headers="mcps1.1.3.1.2 "><p id="p15175mcpsimp"><a name="p15175mcpsimp"></a><a name="p15175mcpsimp"></a>BT.709 FULL to RGB LIMIT Color Space CSC matrix.</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="59%" headers="mcps1.1.3.1.2 "><p id="p15180mcpsimp"><a name="p15180mcpsimp"></a><a name="p15180mcpsimp"></a>RGB FULL to BT.601 LIMIT Color Space CSC matrix.</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="59%" headers="mcps1.1.3.1.2 "><p id="p15185mcpsimp"><a name="p15185mcpsimp"></a><a name="p15185mcpsimp"></a>RGB FULL to BT.601 FULL Color Space CSC matrix.</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="59%" headers="mcps1.1.3.1.2 "><p id="p15190mcpsimp"><a name="p15190mcpsimp"></a><a name="p15190mcpsimp"></a>RGB FULL to BT.709 LIMIT Color Space CSC matrix.</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="59%" headers="mcps1.1.3.1.2 "><p id="p15195mcpsimp"><a name="p15195mcpsimp"></a><a name="p15195mcpsimp"></a>RGB FULL to BT.709 FULL Color Space CSC matrix.</p>
</td>
</tr>
</tbody>
</table> **Notes** None **Related Data Types and Interfaces** ss\_mpi\_vo\_set\_layer\_csc ## ot\_vo\_csc<a name="ZH-CN_TOPIC_0000002471085670"></a> **Description** Defines the image output effect structure. **Definition** ```
typedef struct { ot_vo_csc_matrix csc_matrix; td_u32 luma; td_u32 contrast; td_u32 hue; td_u32 saturation; td_bool ex_csc_en;
} ot_vo_csc;
``` **Members** <a name="table15215mcpsimp"></a>
...
<td class="cellrowborder" valign="top" width="61%" headers="mcps1.1.3.1.2 "><p id="p15230mcpsimp"><a name="p15230mcpsimp"></a><a name="p15230mcpsimp"></a>CS Cmatrix selection.</p>
</td>
</tr>
...
</table> **Difference Description** <a name="table15259mcpsimp"></a>
...
<tbody><tr id="row15270mcpsimp"><td class="cellrowborder" valign="top" width="52%" headers="mcps1.1.3.1.1 "><p id="p15272mcpsimp"><a name="p15272mcpsimp"></a><a name="p15272mcpsimp"></a>Hi3403V100</p>
</td>
<td class="cellrowborder" valign="top" width="48%" headers="mcps1.1.3.1.2 "><p id="p15274mcpsimp"><a name="p15274mcpsimp"></a><a name="p15274mcpsimp"></a>Luminance Valuevalid range: [0,100]; </p>
<p id="p15275mcpsimp"><a name="p15275mcpsimp"></a><a name="p15275mcpsimp"></a>Contrast Valuevalid range: [0,100]; </p>
<p id="p15276mcpsimp"><a name="p15276mcpsimp"></a><a name="p15276mcpsimp"></a>Hue Valuevalid range: [0,100]; </p>
<p id="p15277mcpsimp"><a name="p15277mcpsimp"></a><a name="p15277mcpsimp"></a>Saturation Valuevalid range: [0,100].</p>
<p id="p15278mcpsimp"><a name="p15278mcpsimp"></a><a name="p15278mcpsimp"></a>Luminance Extension Switchvalid range: [0,1].</p>
</td>
</tr>
</tbody>
</table> **Notes** None **Related Data Types and Interfaces** ss\_mpi\_vo\_set\_layer\_csc ## ot\_vo\_vga\_param<a name="ZH-CN_TOPIC_0000002503965621"></a> **Description** Defines the VGA Image Output Effect Structure. **Definition** ```
typedef struct { ot_vo_csc csc; td_u32 gain; td_s32 sharpen_strength;
} ot_vo_vga_param;
``` **Members** <a name="table15296mcpsimp"></a>
...
<td class="cellrowborder" valign="top" width="74%" headers="mcps1.1.3.1.2 "><p id="p15311mcpsimp"><a name="p15311mcpsimp"></a><a name="p15311mcpsimp"></a>VGA Image Adjust Structure, Specific Reference<span xml:lang="pt-BR" id="ph15313mcpsimp"><a name="ph15313mcpsimp"></a><a name="ph15313mcpsimp"></a>ot_vo_csc</span></a>.</p>
...
<td class="cellrowborder" valign="top" width="74%" headers="mcps1.1.3.1.2 "><p id="p15331mcpsimp"><a name="p15331mcpsimp"></a><a name="p15331mcpsimp"></a>DAC Gainvalue.</p>
...
<td class="cellrowborder" valign="top" width="74%" headers="mcps1.1.3.1.2 "><p id="p15337mcpsimp"><a name="p15337mcpsimp"></a><a name="p15337mcpsimp"></a>Sharpen Intensityvalue.</p>
<p id="p15338mcpsimp"><a name="p15338mcpsimp"></a><a name="p15338mcpsimp"></a>valid range: [0,255], Default value:128.</p>
</td>
</tr>
</tbody>
</table> **Difference Description** <a name="table15340mcpsimp"></a>
...
<p id="p15168102910915"><a name="p15168102910915"></a><a name="p15168102910915"></a>gain Default value:0xE</p>
<p id="p55112377915"><a name="p55112377915"></a><a name="p55112377915"></a>Other Timingunder: </p>
<p id="p15355mcpsimp"><a name="p15355mcpsimp"></a><a name="p15355mcpsimp"></a>gain Default value:0xA</p>
</td>
</tr>
</td>
<td class="cellrowborder" valign="top" width="52.93%" headers="mcps1.1.3.1.2 "><p id="p15360mcpsimp"><a name="p15360mcpsimp"></a><a name="p15360mcpsimp"></a>gain Default value:0xB</p>
</td>
</tr>
</td>
<td class="cellrowborder" valign="top" width="52.93%" headers="mcps1.1.3.1.2 "><p id="p1763553145918"><a name="p1763553145918"></a><a name="p1763553145918"></a>gain Default value:0x11</p>
</td>
</tr>
...
</table> **Notes** None **Related Data Types and Interfaces** ss\_mpi\_vo\_set\_vga\_param ## ot\_vo\_hdmi\_param<a name="ZH-CN_TOPIC_0000002471085710"></a> **Description** Definition HDMI Image Output Effect Structure. **Definition** ```
typedef struct { ot_vo_csc csc;
} ot_vo_hdmi_param; ``` **Members** <a name="table15381mcpsimp"></a>
...
<td class="cellrowborder" valign="top" width="76%" headers="mcps1.1.3.1.2 "><p id="p15396mcpsimp"><a name="p15396mcpsimp"></a><a name="p15396mcpsimp"></a>HDMI Image Adjust Structure, Specific Reference<span xml:lang="pt-BR" id="ph15398mcpsimp"><a name="ph15398mcpsimp"></a><a name="ph15398mcpsimp"></a>ot_vo_csc</span></a>.</p>
...
</table> **Notes** None **Related Data Types and Interfaces** ss\_mpi\_vo\_set\_hdmi\_param ## ot\_vo\_rgb\_param<a name="ZH-CN_TOPIC_0000002471085720"></a> **Description** Definition RGB Image Output Effect Structure. **Definition** ```
typedef struct { ot_vo_csc csc; td_bool rgb_inverted_en; td_bool bit_inverted_en;
} ot_vo_rgb_param;
``` **Members** <a name="table15443mcpsimp"></a>
...
<td class="cellrowborder" valign="top" width="74%" headers="mcps1.1.3.1.2 "><p id="p15458mcpsimp"><a name="p15458mcpsimp"></a><a name="p15458mcpsimp"></a>RGB Image Adjust Structure.</p>
...
<td class="cellrowborder" valign="top" width="74%" headers="mcps1.1.3.1.2 "><p id="p15476mcpsimp"><a name="p15476mcpsimp"></a><a name="p15476mcpsimp"></a>"R", "G", "B"Orderorder Normaland Inverted Set, Normal as RGB, Inverted as BGR, DefaultTD_FALSEnotInverted, i.e., NormalRGB, The following Descriptionleft as Height Bit Pin, right as low Bit Pin.</p>
...
</table> **Notes** AndLineInterfaceOT\_VO\_INTF\_RGB\_16BIT, OT\_VO\_INTF\_RGB\_18BIT, OT\_VO\_INTF\_RGB\_24BITOutputwhen, Whenrgb\_inverted\_enandbit\_inverted\_enSimultaneouslyconfigured as TD\_TRUE, "RGBInverted"firsttakes effect, "bit Bit Reversalorder"aftertakes effect. **Related Data Types and Interfaces** ss\_mpi\_vo\_set\_rgb\_param ## ot\_vo\_clk\_edge<a name="ZH-CN_TOPIC_0000002471085708"></a> **Description** Definition Clocksingleedgedualedgetype. **Definition** ```
typedef enum { OT_VO_CLK_EDGE_SINGLE = 0, /* single-edge mode */ OT_VO_CLK_EDGE_DUAL, /* dual-edge mode */ OT_VO_CLK_EDGE_BUTT
} ot_vo_clk_edge;
``` **Members** <a name="table14030mcpsimp"></a>
<table><thead align="left"><tr id="row14035mcpsimp"><th class="cellrowborder" valign="top" width="48%" id="mcps1.1.3.1.1"><p id="p14037mcpsimp"><a name="p14037mcpsimp"></a><a name="p14037mcpsimp"></a>Member Name</p>
</th>
...
</table> **Notes** None **Related Data Types and Interfaces** None. ## ot\_vo\_bt\_param<a name="ZH-CN_TOPIC_0000002503965683"></a> **Description** Definition BT.1120Or BT.656Image Output Effect Structure. **Definition** ```
typedef struct { td_bool yc_inverted_en; td_bool bit_inverted_en; ot_vo_clk_edge clk_edge;
} ot_vo_bt_param;
``` **Members** <a name="table15511mcpsimp"></a>
...
<td class="cellrowborder" valign="top" width="71%" headers="mcps1.1.3.1.2 "><p id="p15526mcpsimp"><a name="p15526mcpsimp"></a><a name="p15526mcpsimp"></a>"Y", "C"Orderorder Normaland Inverted Set, Normal as YC, Inverted as CY, DefaultTD_FALSEnotInverted, i.e., YC, The following Descriptionleft as Height Bit Pin, right as low Bit Pin.</p>
...
<td class="cellrowborder" valign="top" width="71%" headers="mcps1.1.3.1.2 "><p id="p1767554512917"><a name="p1767554512917"></a><a name="p1767554512917"></a>Interfacesingledualedge Output, Static Attribute.BT.1120Interface Supportedsingledualedge Configure Output, BT.656Interface Only supportedsingleedge Configure Output.</p>
</td>
</tr>
</tbody>
</table> **Difference Description** <a name="table15259mcpsimp"></a>
...
<tr id="row349119599327"><td class="cellrowborder" valign="top" width="52%" headers="mcps1.1.3.1.1 "><p id="p449285913323"><a name="p449285913323"></a><a name="p449285913323"></a>Hi3403V100</p>
</td>
...
</table> **Notes** InterfaceOT\_VO\_INTF\_BT1120Outputwhen, Whenyc\_inverted\_enandbit\_inverted\_enSimultaneouslyconfigured as TD\_TRUE, "YCInverted"firsttakes effect, "bit Bit Reversalorder"aftertakes effect. **Related Data Types and Interfaces** ss\_mpi\_vo\_set\_bt\_param ## ot\_vo\_mipi\_param<a name="ZH-CN_TOPIC_0000002470925698"></a> **Description** Definition MIPI Image Output Effect Structure. **Definition** ```
typedef struct { ot_vo_csc csc;
} ot_vo_mipi_param; ``` **Members** <a name="table15556mcpsimp"></a>
...
<td class="cellrowborder" valign="top" width="74%" headers="mcps1.1.3.1.2 "><p id="p15571mcpsimp"><a name="p15571mcpsimp"></a><a name="p15571mcpsimp"></a>MIPI Image Adjust Structure, Specific Reference<span xml:lang="pt-BR" id="ph15573mcpsimp"><a name="ph15573mcpsimp"></a><a name="ph15573mcpsimp"></a>ot_vo_csc</span></a>.</p>
...
</table> **Notes** None **Related Data Types and Interfaces** ss\_mpi\_vo\_set\_mipi\_param ## ot\_vo\_partition\_mode<a name="ZH-CN_TOPIC_0000002504085583"></a> **Description** Definition Video Layer Split Processing Mode. **Definition** ```
typedef enum { OT_VO_PARTITION_MODE_SINGLE = 0, OT_VO_PARTITION_MODE_MULTI = 1, OT_VO_PARTITION_MODE_BUTT,
} ot_vo_partition_mode;
``` **Members** <a name="table15616mcpsimp"></a>
...
<td class="cellrowborder" valign="top" width="48%" headers="mcps1.1.3.1.2 "><p id="p15630mcpsimp"><a name="p15630mcpsimp"></a><a name="p15630mcpsimp"></a>Video Layer According tosingle Region Configure give Hardware Display.</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="48%" headers="mcps1.1.3.1.2 "><p id="p15634mcpsimp"><a name="p15634mcpsimp"></a><a name="p15634mcpsimp"></a>Video Layer According tomany Region Configure give Hardware Display.</p>
</td>
</tr>
</tbody>
</table> **Notes** VO Softwarethisnothaswill Multiplechannel Image Splicing Function, Generally Via Two Types Methodprocessing: - Via Hardwaremany RegionmanagearrangeDisplay, CorrespondingOT\_VO\_PARTITION\_MODE\_MULTIMode, The Mode Not supported Region Overlap; - Via Internal CallsVGS Splicing, mostfinal Configure single Splicing Afterfull Imagegive HardwareDisplay, CorrespondingOT\_VO\_PARTITION\_MODE\_SINGLEMode, The Mode Supported Region Overlap. **Related Data Types and Interfaces** ss\_mpi\_vo\_set\_video\_layer\_attr ## ot\_vo\_video\_layer\_attr<a name="ZH-CN_TOPIC_0000002503965649"></a> **Description** Definition Video Layer Attribute. Video Layer Attribute Involvesthree Concept, i.e., Device Resolution, Display Resolutionand Image Resolution.Eachkind Resolution Concept Can From[graph1](#fig6668153818132)seenexit. - Image Resolutionconfigureeach Channel Imagecanvas size.
- Display Resolution Is Image Resolution DescriptioncanvasafterVO Zoom Or Crop After Display Region.
- Device Resolution And Device Timing Consistent, i.e., If Timing as 1080P30, then Device Resolutionthen as 1920 x 1080. **Figure 1** Video Layer Attribute Related Conceptshownmeaning<a name="fig6668153818132"></a> ![](figures/Video Layerclose Conceptshownmeaning.png "Video Layerclose Conceptshownmeaning") Video Layer Memory Uses as Channel Gathered(As shown in [Figure2](#fig7456922191515))and Non-Gathered(As shown in [Figure3](#fig157172419164))Two Types Method. - Gathered Method: - Determines Memory Allocate Size Factor: Actual Displaychannel Resolutiontotaland. - Not supported Video Layer Zoom Function. - Onlysuitable Used forMULTI Mode. - Gathered Method Enabledafter, RegardingMULTI Mode Under Video Layer, Can Calls Cha nn el Display Position Interface(ss\_mpi\_vo\_set\_chn\_display\_pos)tocombinearrangecanvaslayoutchannel Display Position. **Figure 2** Video Layer Uses Gathered Memory Method Scenarioa(Gathered Uses Memory)<a name="fig7456922191515"></a> ![](figures/Video Layer Usesintersection Memory Method Scenarioa（intersection Uses Memory）.png "Video Layer Usesintersection Memory Method Scenarioa（intersection Uses Memory）").png "Video Layer Uses Gathered Memory Method Scenarioa(Gathered Uses Memory)")
- Non-Gathered Method: - Determines Memory Allocate Size Factor: Layer Onchannel Start Coordinate(0, 0)Andmostrightundercorner Coordinate Determines Region Size. - Supported Video Layer Zoom Function. - Splicinggood Image Pictureafter, Channel Pic tu reD isp la yP os it io nn ot Can Vi as s\_mpi\_vo\_set\_chn\_display\_po sI nt er face Ad just. **Figure 3** Video Layer Uses Non-Gathered Memory Method Scenariob(Non-Gathered Uses Memory)<a name="fig157172419164"></a> ![](figures/Video Layer Uses Non-intersection Memory Method Scenariob（Non-intersection Uses Memory）.png "Video Layer Uses Non-intersection Memory Method Scenariob（Non-intersection Uses Memory）").png "Video Layer Uses Non-Gathered Memory Method Scenariob(Non-Gathered Uses Memory)") **Definition** ```
typedef struct { ot_rect display_rect; ot_size img_size; td_u32 display_frame_rate; ot_pixel_format pixel_format; td_bool double_frame_en; td_bool cluster_mode_en; ot_dynamic_range dst_dynamic_range; td_u32 display_buf_len; ot_vo_partition_mode partition_mode; ot_compress_mode compress_mode;
} ot_vo_video_layer_attr;
``` **Members** <a name="table15687mcpsimp"></a>
...
<td class="cellrowborder" valign="top" width="74%" headers="mcps1.1.3.1.2 "><p id="p15702mcpsimp"><a name="p15702mcpsimp"></a><a name="p15702mcpsimp"></a>Video Display Region Rectangle Structure, In SINGLE modedisplay_rect as Dynamic Attribute; In MULTI modedisplay_rect as Static Attribute.</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="74%" headers="mcps1.1.3.1.2 "><p id="p15707mcpsimp"><a name="p15707mcpsimp"></a><a name="p15707mcpsimp"></a>Image Resolution Structure, i.e., combine Picture Size, Static Attribute.</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="74%" headers="mcps1.1.3.1.2 "><p id="p15712mcpsimp"><a name="p15712mcpsimp"></a><a name="p15712mcpsimp"></a>Video Display Framerate, Static Attribute.</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="74%" headers="mcps1.1.3.1.2 "><p id="p15717mcpsimp"><a name="p15717mcpsimp"></a><a name="p15717mcpsimp"></a>Video Layer Input Pixel format: YVU420 SEMIPLANAR, YVU422 SEMIPLANAR, YUV420 SEMIPLANAR, YUV422 SEMIPLANAR, YUV400, Static Attribute.</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="74%" headers="mcps1.1.3.1.2 "><p id="p15722mcpsimp"><a name="p15722mcpsimp"></a><a name="p15722mcpsimp"></a>Video Layertimes Frame Switch, Static Attribute.</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="74%" headers="mcps1.1.3.1.2 "><p id="p15727mcpsimp"><a name="p15727mcpsimp"></a><a name="p15727mcpsimp"></a>Video Layer Memory Gathered Enabled Switch, Static Attribute.</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="74%" headers="mcps1.1.3.1.2 "><p id="p15732mcpsimp"><a name="p15732mcpsimp"></a><a name="p15732mcpsimp"></a>Video Layer Output Dynamic Rangetype, Static Attribute.</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="74%" headers="mcps1.1.3.1.2 "><p id="p15737mcpsimp"><a name="p15737mcpsimp"></a><a name="p15737mcpsimp"></a>Video Layer Display Buffer Length, Static Attribute.</p>
<a name="ul15410185012312"></a><a name="ul15410185012312"></a><ul id="ul15410185012312"><li>Non-Savebuffer Solutionundervalid range: [0], [3, 15].</li><li>Savebuffer Solutionundervalid range: [0], [2,15].</li></ul>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="74%" headers="mcps1.1.3.1.2 "><p id="p15749mcpsimp"><a name="p15749mcpsimp"></a><a name="p15749mcpsimp"></a>Video Layer Supported Compression OrDecompressionMode: SupportedOT_COMPRESS_MODE_NONE, OT_COMPRESS_MODE_SEG, OT_COMPRESS_MODE_SEG_COMPACT, OT_COMPRESS_MODE_LINE, Static Attribute.</p>
</td>
</tr>
</tbody>
</table> **Difference Description** <a name="table15751mcpsimp"></a>
...
<th class="cellrowborder" valign="top" width="32%" id="mcps1.1.4.1.3"><p id="p15763mcpsimp"><a name="p15763mcpsimp"></a><a name="p15763mcpsimp"></a>Input Pixel format</p>
</th>
</tr>
</thead>
</td>
...
<tr id="row15884mcpsimp"><td class="cellrowborder" valign="top" headers="mcps1.1.4.1.1 "><p id="p15886mcpsimp"><a name="p15886mcpsimp"></a><a name="p15886mcpsimp"></a>VSD0Video Layerbind to DHD1when Maximum resolution for standard timing is 4096x2160, user timing supported maximum resolution is 4096x4096, bind toDSD0when Maximum resolution for standard timing is 720x576, user timing supported maximum resolution is 720x720.That is, display_rect cannot exceed this value.</p>
</td>
</tr>
</tbody>
</table> **Notes** - display\_rectRangecannot ex ce ed sD ev ic eR es ol ut io n.img\_sizeanddisplay\_rect Ra ng ea ll need Great er Tha nO rE qu al to Display Minimum Resolution32x32.
...
- Display Region Width Exceeds3840Scenariowhen, Not supported Pixel format YVU420 SEMIPLANAR Or YUV420 SEMIPLANAR, And And Not supported Video Layer Scaling. **Related Data Types and Interfaces** ss\_mpi\_vo\_set\_video\_layer\_attr ## ot\_vo\_layer\_param<a name="ZH-CN_TOPIC_0000002503965599"></a> **Description** Definition Video Layer Parameter, Used for Adjust Video Layerinside Videoinsidecontent Display Effect. **Definition** ```
typedef struct { ot_aspect_ratio aspect_ratio;
} ot_vo_layer_param;
``` **Members** <a name="table15923mcpsimp"></a>
...
<td class="cellrowborder" valign="top" width="81%" headers="mcps1.1.3.1.2 "><p id="p15938mcpsimp"><a name="p15938mcpsimp"></a><a name="p15938mcpsimp"></a>Video Layerinside Video Aspect Ratio, see "System Control"Chapter.</p>
</td>
</tr>
</tbody>
</table> **Notes** - Manual Modeunder, Aspect Rat io Parameter In Video Region video\_rect \(x, y, width, height\): Coordinate\(x, y\)value Video Lay er Attr ib ut eM em be rd isp la y\_rectByinside, CoordinateBydisplay\_rect as Reference; Wid th Height value Ra ng e as : img\_size Width Height=< \(width, height\)<=display\_rect Width Height, EspeciallyDescription, Ifimg\_size Width Heightrelativelydisplay\_rect Width Heightlarge, ThenAny Aspect Ratio Parameter Allinvalid——None Set Aspect Ratio.
- Aspect Rat io Parameter In Video Region video\_rectRequirement2Aligned.
- Aspect Ratio Background Color Range as \[0, 0x FFFFFF\]. **Related Data Types and Interfaces** ss\_mpi\_vo\_set\_video\_layer\_param ## ot\_vo\_chn\_attr<a name="ZH-CN_TOPIC_0000002471085702"></a> **Description** Defines the video output Channel attribute. **Definition** ```
typedef struct { td_u32 priority; ot_rect rect; td_bool deflicker_en;
} ot_vo_chn_attr;
``` **Members** <a name="table15957mcpsimp"></a>
...
<td class="cellrowborder" valign="top" width="81%" headers="mcps1.1.3.1.2 "><p id="p15972mcpsimp"><a name="p15972mcpsimp"></a><a name="p15972mcpsimp"></a>Video Channel Overlay Priority, valuelarge Priority Height, Priority Heighton Layer.</p>
<p id="p15973mcpsimp"><a name="p15973mcpsimp"></a><a name="p15973mcpsimp"></a>The AttributeonlySINGL Evalid in mode.</p>
...
<td class="cellrowborder" valign="top" width="81%" headers="mcps1.1.3.1.2 "><p id="p15981mcpsimp"><a name="p15981mcpsimp"></a><a name="p15981mcpsimp"></a>Channel Rectangle Display Region.By Screentop-left corner as origin Point.Itsvalue Must Is2Aligned, And The Rectangle Regionmust be Screen Range Within.<strong id="b15982mcpsimp"><a name="b15982mcpsimp"></a><a name="b15982mcpsimp"></a>Note: In MULTI mode with interlaced timing and SPY Cb Cr420/SPY Cr Cb420 display, the height must be 4-aligned.</strong></p>
<p id="p15983mcpsimp"><a name="p15983mcpsimp"></a><a name="p15983mcpsimp"></a>Dynamic Attribute.start Pointand Width Height Requirement2Aligned, Channel Width Height Mustnot Less Than32.</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="81%" headers="mcps1.1.3.1.2 "><p id="p15988mcpsimp"><a name="p15988mcpsimp"></a><a name="p15988mcpsimp"></a>Whether Enabled Anti-flickerflicker.</p>
...
<p id="p73194431967"><a name="p73194431967"></a><a name="p73194431967"></a>Anti-flickerflicker Effect Need CallsVGS Implements, fixedonlySINGL Evalid in mode.</p>
<p id="p1531917437617"><a name="p1531917437617"></a><a name="p1531917437617"></a>Dynamic Attribute.</p>
</td>
</tr>
</tbody>
</table> **Notes** - In SINGLE mode, When Multiple Channel Has Overlap Display Regionwhen, Priority Height Channel Imagewill Override Prioritylow Channel.Prioritysameeach Channel Has Overlapwhen, Default Channel numberlarge Imagewill Override Channel numbersmall Channel Image.
- If Has Video Layer Zoom Situation, rect Is Zoombefore Video Layer On Start Positionand Width Height, Zoomafter Display Start Positionand Width Heightwill Press Video Layer Zoom Compareexample Offset Or Zoom. **Related Data Types and Interfaces** ss\_mpi\_vo\_set\_chn\_attr ## ot\_vo\_chn\_param<a name="ZH-CN_TOPIC_0000002503965581"></a> **Description** Defines the video output Channel Parameter, Used for Aspect Ratio Function. **Definition** ```
typedef struct { ot_aspect_ratio aspect_ratio;
} ot_vo_chn_param;
``` **Members** <a name="table16008mcpsimp"></a>
...
<td class="cellrowborder" valign="top" width="81%" headers="mcps1.1.3.1.2 "><p id="p16023mcpsimp"><a name="p16023mcpsimp"></a><a name="p16023mcpsimp"></a>Aspect Ratio Parameter.</p>
</td>
</tr>
</tbody>
</table> **Notes** - Set Aspect Ratio Parameter Can Implements User Need Display Video Size, Regardinghas no Video Display Region Via Set Should Colortofillfill.
...
- ss\_mpi\_vo\_set\_chn\_attr ## ot\_vo\_zoom\_in\_type<a name="ZH-CN_TOPIC_0000002503965593"></a> **Description** Definition Local Zoomtype. **Definition** ```
typedef enum { OT_VO_ZOOM_IN_RECT = 0, OT_VO_ZOOM_IN_RATIO = 1, OT_VO_ZOOM_IN_BUTT,
} ot_vo_zoom_in_type;
``` **Members** <a name="table16047mcpsimp"></a>
...
<td class="cellrowborder" valign="top" width="56.99999999999999%" headers="mcps1.1.3.1.2 "><p id="p16062mcpsimp"><a name="p16062mcpsimp"></a><a name="p16062mcpsimp"></a>Press Rectangle Local Zoom.</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="56.99999999999999%" headers="mcps1.1.3.1.2 "><p id="p16067mcpsimp"><a name="p16067mcpsimp"></a><a name="p16067mcpsimp"></a>Press Compareexample Local Zoom.</p>
</td>
</tr>
...
</table> **Notes** None. **Related Data Types and Interfaces** ss\_mpi\_vo\_set\_zoom\_in\_window ## ot\_vo\_zoom\_ratio<a name="ZH-CN_TOPIC_0000002471085728"></a> **Description** Definition Press Compareexample Local Zoom Structure. **Definition** ```
typedef struct { td_u32 x_ratio; td_u32 y_ratio; td_u32 width_ratio; td_u32 height_ratio;
} ot_vo_zoom_ratio;
``` **Members** <a name="table16089mcpsimp"></a>
...
<td class="cellrowborder" valign="top" width="77%" headers="mcps1.1.3.1.2 "><p id="p16104mcpsimp"><a name="p16104mcpsimp"></a><a name="p16104mcpsimp"></a>Screen Coordinate , to-be-Scaling Region Start Pointhorizontal Coordinate And Display Channel Image Width Compareexample.</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="77%" headers="mcps1.1.3.1.2 "><p id="p16109mcpsimp"><a name="p16109mcpsimp"></a><a name="p16109mcpsimp"></a>Screen Coordinate , to-be-Scaling Region Start Pointvertical Coordinate And Display Channel Image Height Compareexample.</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="77%" headers="mcps1.1.3.1.2 "><p id="p16114mcpsimp"><a name="p16114mcpsimp"></a><a name="p16114mcpsimp"></a>Screen Coordinate , to-be-Scaling Region Width And Display Channel Image Width Compareexample.</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="77%" headers="mcps1.1.3.1.2 "><p id="p16119mcpsimp"><a name="p16119mcpsimp"></a><a name="p16119mcpsimp"></a>Screen Coordinate , to-be-Scaling Region Height And Display Channel Image Height Compareexample.</p>
</td>
</tr>
</tbody>
</table> **Notes** - Structure Member Variablevalid range\[0, 1000\].
...
- Get Local Zoom Functionwhen, As long aswill The Structure In Memberallconfigure0, i.e., Can. **Related Data Types and Interfaces** ss\_mpi\_vo\_set\_zoom\_in\_window ## ot\_vo\_zoom\_attr<a name="ZH-CN_TOPIC_0000002471085668"></a> **Description** Definition Local Zoom Attribute Structure.Local Zoomoriginarrangeshownmeaning As shown in [Figure1](#fig11364335172211). **Figure 1** Local Zoomoriginarrangeshownmeaning<a name="fig11364335172211"></a> ![](figures/layoutpartlargeoriginarrangeshownmeaning.png "layoutpartlargeoriginarrangeshownmeaning") **Definition** ```
typedef struct { ot_vo_zoom_in_type zoom_type; union { ot_rect zoom_rect; ot_vo_zoom_ratio zoom_ratio; };
} ot_vo_zoom_attr;
``` **Members** <a name="table16146mcpsimp"></a>
...
<td class="cellrowborder" valign="top" width="61%" headers="mcps1.1.3.1.2 "><p id="p16160mcpsimp"><a name="p16160mcpsimp"></a><a name="p16160mcpsimp"></a>Local Zoomtype.</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="61%" headers="mcps1.1.3.1.2 "><p id="p16166mcpsimp"><a name="p16166mcpsimp"></a><a name="p16166mcpsimp"></a>Local Zoomwindow Rectangle Coordinate.Local Zoomwindownot Less Than32x32(, i.e., Width Heightnot Less Than32)</p>
</td>
</tr>
...
- In SINGLE modechannel Width Height Andcapture Getwindow Width Height Comparevaluecannot be greater than16. **Related Data Types and Interfaces** ss\_mpi\_vo\_set\_zoom\_in\_window ## ot\_vo\_border<a name="ZH-CN_TOPIC_0000002471085722"></a> **Description** Definition Border Attribute Structure. **Definition** ```
typedef struct { td_bool enable; ot_border border;
} ot_vo_border;
``` **Members** <a name="table16194mcpsimp"></a>
...
<td class="cellrowborder" valign="top" width="64%" headers="mcps1.1.3.1.2 "><p xml:lang="sv-SE" id="p16209mcpsimp"><a name="p16209mcpsimp"></a><a name="p16209mcpsimp"></a>Whether Enabled Border.</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="64%" headers="mcps1.1.3.1.2 "><p xml:lang="sv-SE" id="p16214mcpsimp"><a name="p16214mcpsimp"></a><a name="p16214mcpsimp"></a>Border Attribute Structure, Includes Bordereachedge Widthand Border Color.</p>
</td>
</tr>
</tbody>
</table> **Notes** Border Widthvalid range\[0,14\], And as evennumber.V Oon Bordereachedge Width Allowednotetc.. **Related Data Types and Interfaces** - ss\_mpi\_vo\_set\_chn\_border
- ss\_mpi\_vo\_get\_chn\_border ## ot\_vo\_mirror\_mode<a name="ZH-CN_TOPIC_0000002504085577"></a> **Description** Definition Channel Mirrortype. **Definition** ```
typedef enum { OT_VO_MIRROR_NONE = 0, OT_VO_MIRROR_HOR = 1, OT_VO_MIRROR_VER = 2, OT_VO_MIRROR_BOTH = 3, OT_VO_MIRROR_BUTT
} ot_vo_mirror_mode;
``` **Members** <a name="table16235mcpsimp"></a>
...
<td class="cellrowborder" valign="top" width="59%" headers="mcps1.1.3.1.2 "><p id="p16250mcpsimp"><a name="p16250mcpsimp"></a><a name="p16250mcpsimp"></a>Channel Image Mirrortype as not Mirror Operation.</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="59%" headers="mcps1.1.3.1.2 "><p id="p16255mcpsimp"><a name="p16255mcpsimp"></a><a name="p16255mcpsimp"></a>Channel Image Mirrortype as Horizontal Mirror Operation.</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="59%" headers="mcps1.1.3.1.2 "><p id="p16260mcpsimp"><a name="p16260mcpsimp"></a><a name="p16260mcpsimp"></a>Channel Image Mirrortype as Vertical Mirror Operation.</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="59%" headers="mcps1.1.3.1.2 "><p id="p16265mcpsimp"><a name="p16265mcpsimp"></a><a name="p16265mcpsimp"></a>Channel Image Mirrortype as Horizontaland Vertical Mirror Operation.</p>
</td>
</tr>
</tbody>
</table> **Notes** None. **Related Data Types and Interfaces** - ss\_mpi\_vo\_set\_chn\_mirror
- ss\_mpi\_vo\_get\_chn\_mirror ## ot\_vo\_chn\_status<a name="ZH-CN_TOPIC_0000002504085521"></a> **Description** Video Output Channel Status Structure. **Definition** ```
typedef struct { td_u32 chn_buf_used; td_u32 chn_busy_num;
} ot_vo_chn_status;
``` **Members** <a name="table16283mcpsimp"></a>
...
<td class="cellrowborder" valign="top" width="61%" headers="mcps1.1.3.1.2 "><p id="p16298mcpsimp"><a name="p16298mcpsimp"></a><a name="p16298mcpsimp"></a>Video Output Channel Current Occupied Videobuffer Number.</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="61%" headers="mcps1.1.3.1.2 "><p id="p16303mcpsimp"><a name="p16303mcpsimp"></a><a name="p16303mcpsimp"></a>Current Channelqueue Column Videobuffer Number.</p>
</td>
</tr>
</tbody>
</table> **Notes** Channel Current Occupiedbuffer Number Includes Current Channelqueue Columnand Channel Currently Displaybuffer. **Related Data Types and Interfaces** ss\_mpi\_vo\_query\_chn\_status ## ot\_vo\_wbc\_attr<a name="ZH-CN_TOPIC_0000002471085672"></a> **Description** Writeback Device Attribute. **Definition** ```
typedef struct { ot_size target_size; ot_pixel_format pixel_format; td_u32 frame_rate; ot_dynamic_range dynamic_range; ot_compress_mode compress_mode;
} ot_vo_wbc_attr;
``` **Members** <a name="table16322mcpsimp"></a>
...
<td class="cellrowborder" valign="top" width="51%" headers="mcps1.1.3.1.2 "><p id="p16337mcpsimp"><a name="p16337mcpsimp"></a><a name="p16337mcpsimp"></a>Writeback Target Size.</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="51%" headers="mcps1.1.3.1.2 "><p id="p16342mcpsimp"><a name="p16342mcpsimp"></a><a name="p16342mcpsimp"></a>Writeback Image Pixel format.</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="51%" headers="mcps1.1.3.1.2 "><p id="p16347mcpsimp"><a name="p16347mcpsimp"></a><a name="p16347mcpsimp"></a>Writeback Video Framerate.</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="51%" headers="mcps1.1.3.1.2 "><p id="p16352mcpsimp"><a name="p16352mcpsimp"></a><a name="p16352mcpsimp"></a>Writeback Video Dynamic Range.</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="51%" headers="mcps1.1.3.1.2 "><p id="p16357mcpsimp"><a name="p16357mcpsimp"></a><a name="p16357mcpsimp"></a>Writeback Video Compression Mode.</p>
</td>
</tr>
</tbody>
</table> **Notes** WhenWritebackmode isOT\_VO\_WBC\_MODE\_PROGRESSIVE\_TO\_INTERLACEDwhen, FramerateControlinvalid. **Related Data Types and Interfaces** None. ## ot\_vo\_wbc\_mode<a name="ZH-CN_TOPIC_0000002503965641"></a> **Description** Writeback Mode Enumerationtype. **Definition** ```
typedef enum { OT_VO_WBC_MODE_NORM = 0, OT_VO_WBC_MODE_DROP_REPEAT = 1, OT_VO_WBC_MODE_PROGRESSIVE_TO_INTERLACED = 2, OT_VO_WBC_MODE_BUTT,
} ot_vo_wbc_mode;
``` **Members** <a name="table16374mcpsimp"></a>
...
<td class="cellrowborder" valign="top" width="59%" headers="mcps1.1.3.1.2 "><p id="p16389mcpsimp"><a name="p16389mcpsimp"></a><a name="p16389mcpsimp"></a>NORMAL Mode, Uses Device Framerate Writeback.The Modeunder, Only Based on Device Framerateand Writeback Framerateto Control Capture Image.</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="59%" headers="mcps1.1.3.1.2 "><p id="p16394mcpsimp"><a name="p16394mcpsimp"></a><a name="p16394mcpsimp"></a>DROP_REPEATMode, DropRepeatDisplayFrame Mode.</p>
<p id="p16395mcpsimp"><a name="p16395mcpsimp"></a><a name="p16395mcpsimp"></a>1, The Modeunder, VO Uses Device Framerateand Video LayerVH Dx Display Framerate Performs Framerate Control Repeat Display Frame, WB Conly Writeback Once.</p>
<p id="p16396mcpsimp"><a name="p16396mcpsimp"></a><a name="p16396mcpsimp"></a>2, The Modeunder, Based on Video Layer VH Dx Display FramerateandWBC Writeback Framerate Performs Framerate Control.</p>
<p id="p16397mcpsimp"><a name="p16397mcpsimp"></a><a name="p16397mcpsimp"></a>3, The Mode Only Device Is Line Display Only When Valid.</p>
<p id="p16398mcpsimp"><a name="p16398mcpsimp"></a><a name="p16398mcpsimp"></a>4, Writebacksource as Device, Then VHD0Displaywhen, VH Dx VHD0; VHD0Disable, VHD2Displaywhen: VH Dx VHD2.</p>
<p id="p16399mcpsimp"><a name="p16399mcpsimp"></a><a name="p16399mcpsimp"></a>5, Writebacksource as Video Layer, Then VH Dx VHD0.</p>
<p id="p16400mcpsimp"><a name="p16400mcpsimp"></a><a name="p16400mcpsimp"></a>6, The Mode At least Hasone Video LayerVH Dx Display Valid.</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="54%" headers="mcps1.1.3.1.2 "><p id="p16455mcpsimp"><a name="p16455mcpsimp"></a><a name="p16455mcpsimp"></a>Writebacksource Is Device.</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="54%" headers="mcps1.1.3.1.2 "><p id="p16460mcpsimp"><a name="p16460mcpsimp"></a><a name="p16460mcpsimp"></a>Writebacksource Is Video Layer.</p>
</td>
</tr>
</tbody>
</table> **Notes** None. **Related Data Types and Interfaces** None. ## ot\_vo\_wbc\_src<a name="ZH-CN_TOPIC_0000002503965619"></a> **Description** Writeback Device Writebacksource. **Definition** ```
typedef struct { ot_vo_wbc_src_type src_type; td_u32 src_id;
} ot_vo_wbc_src;
``` **Members** <a name="table16475mcpsimp"></a>
...
<td class="cellrowborder" valign="top" width="54%" headers="mcps1.1.3.1.2 "><p id="p16495mcpsimp"><a name="p16495mcpsimp"></a><a name="p16495mcpsimp"></a>Writebacksource ID.</p>
</td>
</tr>
</tbody>
</table> **Notes** Writebacksourcetype Is Devicewhen, WritebacksourceID Indicates DeviceID, Writebacksourcetype Is Video Layerwhen, WritebacksourceID Indicates Video Layer ID. **Related Data Types and Interfaces** None. ## ot\_vo\_cas\_mode<a name="ZH-CN_TOPIC_0000002503965677"></a> **Description** Definition Levelsingle Pathdual Path Mode. **Definition** ```
typedef enum { OT_VO_CAS_MODE_SINGLE = 0, OT_VO_CAS_MODE_DUAL = 1, OT_VO_CAS_MODE_BUTT,
} ot_vo_cas_mode;
``` **Members** <a name="table16512mcpsimp"></a>
...
<td class="cellrowborder" valign="top" width="49%" headers="mcps1.1.3.1.2 "><p id="p16527mcpsimp"><a name="p16527mcpsimp"></a><a name="p16527mcpsimp"></a>Levelsingle Path Mode.</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="49%" headers="mcps1.1.3.1.2 "><p id="p16532mcpsimp"><a name="p16532mcpsimp"></a><a name="p16532mcpsimp"></a>Leveldual Path Mode.</p>
</td>
</tr>
</tbody>
</table> **Notes** None. **Related Data Types and Interfaces** None. ## ot\_vo\_cas\_data\_transmission\_mode<a name="ZH-CN_TOPIC_0000002471085676"></a> **Description** Definition Levelsingledualedge Data Transmission Mode. **Definition** ```
typedef enum { OT_VO_CAS_MODE_SINGLE_EDGE = 0, OT_VO_CAS_MODE_DUAL_EDGE = 1, OT_VO_CAS_MODE_EDGE_BUTT,
} ot_vo_cas_data_transmission_mode;
``` **Members** <a name="table16549mcpsimp"></a>
...
<td class="cellrowborder" valign="top" width="49%" headers="mcps1.1.3.1.2 "><p id="p16564mcpsimp"><a name="p16564mcpsimp"></a><a name="p16564mcpsimp"></a>singleedge Data Transmission Mode.</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="49%" headers="mcps1.1.3.1.2 "><p id="p16569mcpsimp"><a name="p16569mcpsimp"></a><a name="p16569mcpsimp"></a>dualedge Data Transmission Mode.</p>
</td>
</tr>
</tbody>
</table> **Notes** None. **Related Data Types and Interfaces** None. ## ot\_vo\_cas\_rgn<a name="ZH-CN_TOPIC_0000002471085678"></a> **Description** Definition Level Regiontype. **Definition** ```
typedef enum { OT_VO_CAS_RGN_64 = 0, OT_VO_CAS_RGN_32, OT_VO_CAS_RGN_BUTT,
} ot_vo_cas_rgn;
``` **Members** <a name="table16586mcpsimp"></a>
...
</table> **Notes** None. **Related Data Types and Interfaces** None. ## ot\_vo\_cas\_attr<a name="ZH-CN_TOPIC_0000002470925658"></a> **Description** Definition Level Attribute. **Definition** ```
typedef struct { td_bool is_slave; ot_vo_cas_rgn cas_rgn; ot_vo_cas_mode cas_mode; ot_vo_cas_data_transmission_mode cas_edge_mode;
} ot_vo_cas_attr;
``` **Members** <a name="table16627mcpsimp"></a>
...
<td class="cellrowborder" valign="top" width="56.99999999999999%" headers="mcps1.1.3.1.2 "><p id="p16642mcpsimp"><a name="p16642mcpsimp"></a><a name="p16642mcpsimp"></a>Video Levelmain From Mode, Static Attribute.</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="56.99999999999999%" headers="mcps1.1.3.1.2 "><p id="p16647mcpsimp"><a name="p16647mcpsimp"></a><a name="p16647mcpsimp"></a>Video Level Regiontype, Static Attribute.</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="56.99999999999999%" headers="mcps1.1.3.1.2 "><p id="p16652mcpsimp"><a name="p16652mcpsimp"></a><a name="p16652mcpsimp"></a>Video Levelsingle Pathdual Path Mode, Static Attribute.</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="56.99999999999999%" headers="mcps1.1.3.1.2 "><p id="p16657mcpsimp"><a name="p16657mcpsimp"></a><a name="p16657mcpsimp"></a>Video Levelsingleedgedualedge Transmission Data Mode, Static Attribute.</p>
</td>
</tr>
</tbody>
</table> **Notes** None **Related Data Types and Interfaces** ss\_mpi\_vo\_set\_cas\_attr ## ot\_vo\_export\_callback<a name="ZH-CN_TOPIC_0000002504085569"></a> **Description** Definition Interrupt Callback Notifiesfunctionnumber Structure. **Definition** ```
typedef struct { void (*vo_notify)(int mod_id, int device);
} ot_vo_export_callback;
``` **Members** <a name="table18420mcpsimp"></a>
...
<td class="cellrowborder" valign="top" width="54%" headers="mcps1.1.3.1.2 "><p id="p18435mcpsimp"><a name="p18435mcpsimp"></a><a name="p18435mcpsimp"></a>Callback Notifiesfunctionnumber Pointer.</p>
</td>
</tr>
</tbody>
</table> **Notes** Kernelstate Uses. **Related Data Types and Interfaces** ot\_vo\_export\_symbol ## ot\_vo\_export\_symbol<a name="ZH-CN_TOPIC_0000002470925642"></a> **Description** Definition Register Interrupt Callbackfunctionnumber Structure. **Definition** ```
typedef struct { ot_vo_register_export_callback *vo_register_export_callback;
} ot_vo_export_symbol;
``` **Members** <a name="table18450mcpsimp"></a>
...
<td class="cellrowborder" valign="top" width="54%" headers="mcps1.1.3.1.2 "><p id="p18465mcpsimp"><a name="p18465mcpsimp"></a><a name="p18465mcpsimp"></a>Register Callback Notifiesfunctionnumber Pointer.</p>
</td>
</tr>
</tbody>
</table> **Notes** Kernelstate Uses. **Related Data Types and Interfaces** ot\_vo\_export\_callback ## ot\_vo\_register\_export\_callback<a name="ZH-CN_TOPIC_0000002470925664"></a> **Description** Definition Register Interrupt Callbackhookchildfunctionnumber. **Definition** ```
typedef td_s32 ot_vo_register_export_callback(ot_vo_export_callback *export_callback);
``` **Members** None. **Notes** None. **Related Data Types and Interfaces** None. # Error Code
Video OutputAPI Error Codeas follows. **Table 1** Video OutputAPI Error Code <a name="_Ref248309361"></a>
<table><thead align="left"><tr id="row18493mcpsimp"><th class="cellrowborder" valign="top" width="18%" id="mcps1.2.4.1.1"><p id="p18495mcpsimp"><a name="p18495mcpsimp"></a><a name="p18495mcpsimp"></a>Error Code</p>
</th>
...
<td class="cellrowborder" valign="top" width="28.999999999999996%" headers="mcps1.2.4.1.3 "><p id="p18542mcpsimp"><a name="p18542mcpsimp"></a><a name="p18542mcpsimp"></a>Not supported Operation</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="28.999999999999996%" headers="mcps1.2.4.1.3 "><p id="p18548mcpsimp"><a name="p18548mcpsimp"></a><a name="p18548mcpsimp"></a>Operationnot Allowed</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="28.999999999999996%" headers="mcps1.2.4.1.3 "><p id="p18566mcpsimp"><a name="p18566mcpsimp"></a><a name="p18566mcpsimp"></a>Allocate Memory Failure</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="28.999999999999996%" headers="mcps1.2.4.1.3 "><p id="p18578mcpsimp"><a name="p18578mcpsimp"></a><a name="p18578mcpsimp"></a>Waits Timeout</p>
</td>
</tr>
