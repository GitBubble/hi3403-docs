...
![](figures/时序信息结构示意图.png "时序information结构示意图")
...
![](figures/视频层使用聚集内存方式的场景a（聚集使用内存）.png).png "Video LayerUsesGatheredMemoryMethodScenarioa(GatheredUsesMemory)")
-  Non-GatheredMethod: 
...
![](figures/视频层使用非聚集内存方式的场景b（非聚集使用内存）.png).png "Video LayerUsesNon-GatheredMemoryMethodScenariob(Non-GatheredUsesMemory)")
