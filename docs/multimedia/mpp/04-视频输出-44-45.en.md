...
-  [OT\_VO\_MAX\_PHYS\_DEV\_NUM](#ZH-CN_TOPIC_0000002504085559): Defines the maximum number of physical video output deviceices.
-  [OT\_VO\_MAX\_VIRT\_DEV\_NUM](#ZH-CN_TOPIC_0000002504085601): Defines the maximum number of virtual video output deviceices.
-  [OT\_VO\_MAX\_CAS\_DEV\_NUM](#ZH-CN_TOPIC_0000002503965613): Defines the maximum number of cascade video output deviceices.
-  [OT\_VO\_MAX\_DEV\_NUM](#ZH-CN_TOPIC_0000002470925732): Defines the maximum number of video output deviceices.
-  [OT\_VO\_VIRT\_DEV\_0](#ZH-CN_TOPIC_0000002470925654): Defines the Device number for virtual deviceice 0.
-  [OT\_VO\_VIRT\_DEV\_1](#ZH-CN_TOPIC_0000002503965607): Defines the Device number for virtual deviceice 1.
-  [OT\_VO\_VIRT\_DEV\_2](#ZH-CN_TOPIC_0000002471085650): Defines the Device number for virtual deviceice 2.
-  [OT\_VO\_VIRT\_DEV\_3](#ZH-CN_TOPIC_0000002504085589): Defines the Device number for virtual deviceice 3.
-  [OT\_VO\_CAS\_DEV\_1](#ZH-CN_TOPIC_0000002471085638): Defines the Device number for cascade deviceice 1.
-  [OT\_VO\_CAS\_DEV\_2](#ZH-CN_TOPIC_0000002471085660): Defines the Device number for cascade deviceice 2.
...
-  [OT\_VO\_MAX\_LAYER\_IN\_DEV](#ZH-CN_TOPIC_0000002504085499): Defines the maximum number of video layers per deviceice.
...
-  [ot\_vo\_get\_virt\_layer](#ZH-CN_TOPIC_0000002504085529): Defines the macro for obtaining the virtual video layer number corresponding to the virtual deviceice.
-  [ot\_vo\_get\_cas\_layer](#ZH-CN_TOPIC_0000002471085688): Defines the macro for obtaining the cascade deviceice video layer number corresponding to the cascade deviceice.
...
-  [OT\_VO\_MAX\_WBC\_NUM](#ZH-CN_TOPIC_0000002471085700): Defines the maximum number of write-back deviceices.
...
-  [ot\_vo\_pub\_attr](#ZH-CN_TOPIC_0000002470925730): Defines the video output deviceice public attribute structure.
-  [ot\_vo\_device\_param](#ZH-CN_TOPIC_0000002504085543): Defines the VO video output deviceice parameter structure.
-  [ot\_vo\_mod\_param](#ZH-CN_TOPIC_0000002503965643): VO module parameters.
-  [ot\_vo\_clk\_src](#ZH-CN_TOPIC_0000002470925708): VO deviceice clock source type.
...
Defines the maximum number of video output physical deviceices.
...
<td class="cellrowborder" valign="top" width="47%" headers="mcps1.1.3.1.2 "><p id="p11599mcpsimp"><a name="p11599mcpsimp"></a><a name="p11599mcpsimp"></a>Up to 3 physical deviceices</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="47%" headers="mcps1.1.3.1.2 "><p id="p11604mcpsimp"><a name="p11604mcpsimp"></a><a name="p11604mcpsimp"></a>Up to 2 physical deviceices</p>
</td>
</tr>
</tbody>
</table>
...
Defines the maximum number of virtual video output deviceices.
...
<td class="cellrowborder" valign="top" width="59%" headers="mcps1.1.3.1.2 "><p id="p11635mcpsimp"><a name="p11635mcpsimp"></a><a name="p11635mcpsimp"></a>Up to 32 virtual deviceices</p>
</td>
</tr>
</tbody>
</table>
...
Defines the maximum number of video output cascade extension deviceices.
...
<td class="cellrowborder" valign="top" width="54%" headers="mcps1.1.3.1.2 "><p id="p11665mcpsimp"><a name="p11665mcpsimp"></a><a name="p11665mcpsimp"></a>Up to 2 cascade extension deviceices</p>
</td>
</tr>
...
Defines the maximum number of video output deviceices.
...
<td class="cellrowborder" valign="top" width="59%" headers="mcps1.1.3.1.2 "><p id="p11702mcpsimp"><a name="p11702mcpsimp"></a><a name="p11702mcpsimp"></a>Up to (OT_VO_MAX_PHYS_DEV_NUM + OT_VO_MAX_VIRT_DEV_NUM + OT_VO_MAX_CAS_DEV_NUM) 37 deviceices</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="59%" headers="mcps1.1.3.1.2 "><p id="p11708mcpsimp"><a name="p11708mcpsimp"></a><a name="p11708mcpsimp"></a>Up to (OT_VO_MAX_PHYS_DEV_NUM + OT_VO_MAX_VIRT_DEV_NUM + OT_VO_MAX_CAS_DEV_NUM) 35 deviceices</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="59%" headers="mcps1.1.3.1.2 "><p id="p11714mcpsimp"><a name="p11714mcpsimp"></a><a name="p11714mcpsimp"></a>Up to (OT_VO_MAX_PHYS_DEV_NUM + OT_VO_MAX_VIRT_DEV_NUM + OT_VO_MAX_CAS_DEV_NUM) 35 deviceices</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="59%" headers="mcps1.1.3.1.2 "><p id="p11720mcpsimp"><a name="p11720mcpsimp"></a><a name="p11720mcpsimp"></a>Up to (OT_VO_MAX_PHYS_DEV_NUM + OT_VO_MAX_VIRT_DEV_NUM + OT_VO_MAX_CAS_DEV_NUM) 34 deviceices</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="59%" headers="mcps1.1.3.1.2 "><p id="p11726mcpsimp"><a name="p11726mcpsimp"></a><a name="p11726mcpsimp"></a>Up to (OT_VO_MAX_PHYS_DEV_NUM + OT_VO_MAX_VIRT_DEV_NUM + OT_VO_MAX_CAS_DEV_NUM) 35 deviceices</p>
</td>
</tr>
</tbody>
</table>
...
Defines the Device number for virtual deviceice 0.
...
<td class="cellrowborder" valign="top" width="63%" headers="mcps1.1.3.1.2 "><p id="p11760mcpsimp"><a name="p11760mcpsimp"></a><a name="p11760mcpsimp"></a>Virtual deviceice 0 deviceice number is 3</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="63%" headers="mcps1.1.3.1.2 "><p id="p11765mcpsimp"><a name="p11765mcpsimp"></a><a name="p11765mcpsimp"></a>Virtual deviceice 0 deviceice number is 2</p>
</td>
</tr>
</tbody>
</table>
...
Defines the Device number for virtual deviceice 1.
...
<td class="cellrowborder" valign="top" width="59%" headers="mcps1.1.3.1.2 "><p id="p11798mcpsimp"><a name="p11798mcpsimp"></a><a name="p11798mcpsimp"></a>Virtual deviceice 1 deviceice number is 4</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="59%" headers="mcps1.1.3.1.2 "><p id="p11803mcpsimp"><a name="p11803mcpsimp"></a><a name="p11803mcpsimp"></a>Virtual deviceice 1 deviceice number is 3</p>
</td>
</tr>
</tbody>
</table>
...
Defines the Device number for virtual deviceice 2.
...
<td class="cellrowborder" valign="top" width="66%" headers="mcps1.1.3.1.2 "><p id="p11836mcpsimp"><a name="p11836mcpsimp"></a><a name="p11836mcpsimp"></a>Virtual deviceice 2 deviceice number is 5</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="66%" headers="mcps1.1.3.1.2 "><p id="p11841mcpsimp"><a name="p11841mcpsimp"></a><a name="p11841mcpsimp"></a>Virtual deviceice 2 deviceice number is 4</p>
</td>
</tr>
</tbody>
</table>
...
Defines the Device number for virtual deviceice 3.
...
<td class="cellrowborder" valign="top" width="51%" headers="mcps1.1.3.1.2 "><p id="p11874mcpsimp"><a name="p11874mcpsimp"></a><a name="p11874mcpsimp"></a>Virtual deviceice 3 deviceice number is 6</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="51%" headers="mcps1.1.3.1.2 "><p id="p11879mcpsimp"><a name="p11879mcpsimp"></a><a name="p11879mcpsimp"></a>Virtual deviceice 3 deviceice number is 5</p>
</td>
</tr>
</tbody>
</table>
...
Defines the Device number for cascade deviceice 1.
...
<td class="cellrowborder" valign="top" width="57.99999999999999%" headers="mcps1.1.3.1.2 "><p id="p11906mcpsimp"><a name="p11906mcpsimp"></a><a name="p11906mcpsimp"></a>Cascade deviceice 1 deviceice number is 35</p>
</td>
</tr>
...
Defines the Device number for cascade deviceice 2.
...
<td class="cellrowborder" valign="top" width="63%" headers="mcps1.1.3.1.2 "><p id="p11939mcpsimp"><a name="p11939mcpsimp"></a><a name="p11939mcpsimp"></a>Cascade deviceice 2 deviceice number is 36</p>
</td>
</tr>
...
Specifies the largest number of video layers on each deviceice.
...
Defines the macro for obtaining the virtual video layer number corresponding to the virtual deviceice.
...
<td class="cellrowborder" valign="top" width="57.99999999999999%" headers="mcps1.1.3.1.2 "><p id="p12500mcpsimp"><a name="p12500mcpsimp"></a><a name="p12500mcpsimp"></a>Virtual deviceice video layer is virtual deviceice number plus 5</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="57.99999999999999%" headers="mcps1.1.3.1.2 "><p id="p12505mcpsimp"><a name="p12505mcpsimp"></a><a name="p12505mcpsimp"></a>Virtual deviceice video layer is virtual deviceice number plus 4</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="57.99999999999999%" headers="mcps1.1.3.1.2 "><p id="p12510mcpsimp"><a name="p12510mcpsimp"></a><a name="p12510mcpsimp"></a>Virtual deviceice video layer is virtual deviceice number plus 6</p>
</td>
</tr>
</tbody>
</table>
...
Defines the macro for obtaining the cascade deviceice video layer number corresponding to the cascade deviceice.
...
<td class="cellrowborder" valign="top" width="59%" headers="mcps1.1.3.1.2 "><p id="p12537mcpsimp"><a name="p12537mcpsimp"></a><a name="p12537mcpsimp"></a>Cascade deviceice video layer is cascade deviceice number plus 5</p>
</td>
</tr>
...
Defines the maximum number of write-back deviceices.
...
<td class="cellrowborder" valign="top" width="63%" headers="mcps1.1.3.1.2 "><p id="p12827mcpsimp"><a name="p12827mcpsimp"></a><a name="p12827mcpsimp"></a>The video output module has 3 video output deviceices, defined as follows:</p>
<p id="p12828mcpsimp"><a name="p12828mcpsimp"></a><a name="p12828mcpsimp"></a>0: DHD0 deviceice, i.e. high-definition display deviceice 0.</p>
<p id="p12829mcpsimp"><a name="p12829mcpsimp"></a><a name="p12829mcpsimp"></a>1: DHD1 deviceice, i.e. high-definition display deviceice 1.</p>
<p id="p12830mcpsimp"><a name="p12830mcpsimp"></a><a name="p12830mcpsimp"></a>2: DSD0 deviceice, i.e. standard-definition display deviceice 2.</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="63%" headers="mcps1.1.3.1.2 "><p id="p12835mcpsimp"><a name="p12835mcpsimp"></a><a name="p12835mcpsimp"></a>The video output module has 2 video output deviceices, defined as follows:</p>
<p id="p12836mcpsimp"><a name="p12836mcpsimp"></a><a name="p12836mcpsimp"></a>0: DHD0 deviceice, i.e. high-definition display deviceice 0.</p>
<p id="p12837mcpsimp"><a name="p12837mcpsimp"></a><a name="p12837mcpsimp"></a>2: DSD0 deviceice, i.e. standard-definition display deviceice 2.</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="63%" headers="mcps1.1.3.1.2 "><p id="p12842mcpsimp"><a name="p12842mcpsimp"></a><a name="p12842mcpsimp"></a>The video output module has 2 video output deviceices, defined as follows:</p>
<p id="p12843mcpsimp"><a name="p12843mcpsimp"></a><a name="p12843mcpsimp"></a>0: DHD0 deviceice, i.e. high-definition display deviceice 0.</p>
<p id="p12844mcpsimp"><a name="p12844mcpsimp"></a><a name="p12844mcpsimp"></a>1: DHD1 deviceice, i.e. high-definition display deviceice 1.</p>
</td>
</tr>
</tbody>
</table>
...
<td class="cellrowborder" valign="top" width="64%" headers="mcps1.1.3.1.2 "><p id="p12934mcpsimp"><a name="p12934mcpsimp"></a><a name="p12934mcpsimp"></a>V0/V1/V3/G0/G1 video layers and graphics layers are fixedly bound to the corresponding deviceices, PIP video layer V2 can be bound to deviceiceDHD0or DHD1 , Mouse layer G2 can be bound to deviceiceDHD0/DHD1/DSD0 , Graphics layer G3 can be bound to deviceiceDHD0/DHD1/DSD0.</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="64%" headers="mcps1.1.3.1.2 "><p id="p12939mcpsimp"><a name="p12939mcpsimp"></a><a name="p12939mcpsimp"></a>V0/V3/G0 video layers and graphics layers are fixedly bound to the corresponding deviceices, PIP video layer V2 can be bound to deviceiceDHD0 , Mouse layer G2 can be bound to deviceiceDHD0/DSD0 , Graphics layer G3 can be bound to deviceiceDHD0/DSD0.</p>
</td>
</tr>
...
-  The interface type of virtual deviceices is an unused parameter and is not checked. Supported timings for virtual deviceices:\[OT\_VO\_OUT\_PAL, OT\_VO\_OUT\_USER\].
...
-  Supports multi-interface same-source output, **Solution**the supported configurations for each deviceice, see[meter1](#table13120152482310). Example of using multiple interface types simultaneously: intf\_type = OT\_VO\_INTF\_BT1120 | OT\_VO\_INTF\_HDMI.
...
-  Device attribute configuration takes effect the next time the deviceice is enabled.
-  Supports BT.1120 interface output timing OT\_VO\_OUT\_3840x2160\_24 to OT\_VO\_OUT\_3840x2160\_30timing uses dual-edge by default, output at 148.5MHz; 148.5MHz output; other timings use single-edge by default. Pay attention to adaptation when connecting to external converter deviceices.
...
Defines the VO video output deviceice parameter structure, used to configure the VO pass-through flag.
...
<p id="p13899mcpsimp"><a name="p13899mcpsimp"></a><a name="p13899mcpsimp"></a>TD_TRUE: Exit VO deviceice.</p>
<p id="p13900mcpsimp"><a name="p13900mcpsimp"></a><a name="p13900mcpsimp"></a>TD_FALSE: Do not exit VO deviceice.</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="71%" headers="mcps1.1.3.1.2 "><p id="p13905mcpsimp"><a name="p13905mcpsimp"></a><a name="p13905mcpsimp"></a>Module parameter, indicating whether the user enables the deviceice interface clock. (default TD_FALSE)</p>
<p id="p13906mcpsimp"><a name="p13906mcpsimp"></a><a name="p13906mcpsimp"></a>TD_TRUE: The VO module does not enable the interface clock internally when the deviceice is enabled; the user enables it.</p>
<p id="p13907mcpsimp"><a name="p13907mcpsimp"></a><a name="p13907mcpsimp"></a>TD_FALSE: The VO module enables the interface clock internally when the deviceice is enabled.</p>
</td>
</tr>
...
-  exit\_device\_en indicates whether to disable the VO deviceice when exiting VO via ss\_mpi\_sys\_exit (see the "System Control" chapter).
-  device_clk_ext_en is mainly used in multi-chip video synchronization scenarios. When enabled, it is set to TRUE. When the deviceice is enabled, the interface clock is not started, and when the deviceice clock is started, it will also be stopped. The user uniformly starts interface clocks for multiple deviceices externally to achieve clock synchronization. Note: For SS528V100/SS625V100/SS524V100/SS522V101, the DSD deviceice clock must be started and kept on by default when the driver loads. For DSD deviceices, the clock register can be set to turn off the clock switch. For SS626V100, the DSD deviceice clock is not started by default.
...
VO deviceice clock source type.
...
The deviceice clock divider ratio is related to **Solution**, deviceice, and interface. See the Clock Divider Ratio Configuration Method table for the recommended configuration method.
...
-  The clock phase inversion clk\_reverse\_en can be configured according to the requirements of the external deviceice, and only takes effect for BT.1120/BT.656/RGB interfaces. The default configuration under non-user timing is shown in the clk\_reverse\_en Default Configuration table.
...
<td class="cellrowborder" valign="top" width="64%" headers="mcps1.2.3.1.2 "><p id="p14862mcpsimp"><a name="p14862mcpsimp"></a><a name="p14862mcpsimp"></a>Depends on the connected deviceice.</p>
</td>
</tr>
...
-  ViaHardwaremanyRegion管arrangeDisplay, CorrespondingOT\_VO\_PARTITION\_MODE\_MULTIMode, TheModeNot supportedRegionOverlap; 
...
-  ImageResolution指configureeachChannelImagecanvas size.
...
**Figure 1** Video LayerAttributeRelatedConceptshown意<a name="fig6668153818132"></a> 
...
![](figures/视频层使用聚集内存方式的场景a（聚集使用内存）.png "视频层使用聚集内存方式的场景a（聚集使用内存）").png "Video LayerUsesGatheredMemoryMethodScenarioa(GatheredUsesMemory)")
-  Non-GatheredMethod: 
...
![](figures/视频层使用非聚集内存方式的场景b（非聚集使用内存）.png "视频层使用非聚集内存方式的场景b（非聚集使用内存）").png "Video LayerUsesNon-GatheredMemoryMethodScenariob(Non-GatheredUsesMemory)")
...
-  WhenDeviceOutput timing  as 隔Linewhen, AndFormat as YVU420 SEMIPLANAROrYUV420 SEMIPLANARwhen, img\_sizeHeightheightanddisplay\_rectHeightheightRequirement4Aligned.
...
-  MultiModeunder, IfFrontendBindVPSS as autoMode, VOwillOccupied4BlockPrivateVBUsed toDisplayRotation Buffer; IfFrontend as UserMode, VOCannotAllocateVB, At this pointOccupiedFrontendModuleSendtoVB, Display完afterRelease.IfEnableBuffer-savingConfigure , CansaveSaveoneBlockVB.
...
-  vpss autoModeScenariowhen, Configure CompressionModecompress\_modeIndicateshopevpsssendBitstreamCompressionMode, In MULTI modeOnlyNo CompressionandLine压Supported, In SINGLE modecompress\_modeParameterColumnexitCompressionModeallSupported.
-  vpss userModeScenariowhen, In MULTI modeConfigure CompressionModecompress\_modeIndicatesCurrentvoSupportedDecompressioncancapability, SpecificDecompressioncancapability见**Solution**Video Layer解CompressionSpecificationmeter.In SINGLE modeVOConfigure ThisDecompressionModeIsinvalid, Non-pass-throughandPass-throughwhenwhenRespectivelyDepends onVGSandVDPDecompressioncancapability, not受ThisConfigure Constraint.
...
-  ParametervaluetoCompareexamplevalueIsZoom1000times, For example待ScalingRegionWidthAndDisplayChannelImageWidthCompareexampleIs0.6, corresponding Parameterwidth\_ratioThenIs600.
...
DefinitionLocalZoomAttribute Structure.LocalZoomoriginarrangeshown意As shown in [Figure1](#fig11364335172211).

**Figure 1** LocalZoomoriginarrangeshown意<a name="fig11364335172211"></a> 
...
-  LocalZoomSupportedTwo TypescaptureGetVOChannelsourceDataMethod, PressPositionandPressCompareexample: 
  -  PressPositionwhen, Configure combineInzoom\_rect, RequirementParameter as Non-negativenumber, Press2PixelAligned.AndLocalZoomwindow口notLess Than32x32.
...
-  IfLocalZoomwindow口PartialExceedsInputImage, ThencaptureGetsourceDataAndwindow口intersectionPartial, IfLocalZoomwindow口fullpartExceedsInputImage, ThenNoneZoomEffect.
-  In SINGLE modechannelWidthHeightAndcaptureGetwindow口WidthHeightComparevaluecannot be greater than16.
...
-  WBCWritebackModeSet as OT\_VO\_WBC\_MODE\_PROGRESSIVE\_TO\_INTERLACEDwhen, IfHeightHD deviceHDIs1080P@60fpsDisplay, VIActualCaptureFramerate as 30fps, WBCwillwill60Frame逐LineDisplayImagetransfer as 30Frame隔LineImage, MakeWritebackAfterImageMonitoronachieve to relativelygoodDisplayEffect.Therefore, WhenHDIs1080P@30fpsDisplaywhen, TheModeunderWBCWritebackFramerateMaximumCan Onlyachieve to 15fps, AndTheModeunderSetFramerateControlinvalid.TheModeunder, WBCActualWritebackFramerateThe following几kindSituation: 
  ...
  -  When1/2 x device\_frame\_rate < display\_frame\_rate < device\_frame\_ratewhen, WBCActualWritebackFrameratenotfixed, 随display\_frame\_ratenotsamechange.
...
-  WBCWritebackModeSet as VO\_WBC\_MODE\_DROP\_REPEATwhen, Video LayerVHD0Display, IfDeviceIs1080P@60fpsDisplay, Video LayerVHD0DisplayFramerate(Writebacksource as Devicewhen, GetVHD0DisplayFramerate) as 30fps, WBConlyWritebackVideo LayerDisplay30FrameImage, Dropon the deviceiceRepeatDisplayFrameImage, , i.e., TheModeunderWritebackFramerateMaximumWill notExceedsVideo LayerDisplayFramerate.For example: DeviceIs1080P@60fpsDisplay, Video LayerDisplayFramerate as 30fps, WritebackFramerate as 15fps, ThenDropRepeatDisplayFrameafterFramerate as f1=30fps, Based onVideo LayerDisplayFrameratef2=30fpsandWritebackFrameratef3=15fpsPerformsFramerateControlActualFramerate as 15fps\(f1\*\(f3/f2\)\).
...
WritebackDevicecapture获Datasourcetype, Used fordistinguishnoteIsFromVideo LayerWritebackstillIsFromDeviceWriteback.
