...
--- # 音频 ## 数据类型
## 音频输入输出<a name="ZH-CN_TOPIC_0000002408259402"></a> 音频输入输出相关数据类型、数据结构定义如下： - [OT\_AIO\_MAX\_NUM](#ZH-CN_TOPIC_0000002441658757)：定义音频输入/输出设备的最大个数。
...
## 音频基础属性错误码<a name="ZH-CN_TOPIC_0000002408259470"></a> **表 1** 音频基础属性API错误码 <a name="_Ref2607614"></a>
