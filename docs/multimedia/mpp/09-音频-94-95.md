...
-   [OT\_AIO\_MAX\_NUM](#ZH-CN_TOPIC_0000002441658757)：定义音频输入/输出设备的最大个数。
...
-   [ot\_ai\_chn\_attr](#ZH-CN_TOPIC_0000002408259490)：定义AI通道属性结构体。
...
赋值给[ot\_ai\_talk\_vqe\_cfg](#ZH-CN_TOPIC_0000002408099574)结构体成员open\_mask表示开启HPF功能。如open\_mask =  [OT\_AI\_TALKVQE\_MASK\_AEC](#ZH-CN_TOPIC_0000002408099426)  | OT\_AI\_TALKVQE\_MASK\_HPF；表示开启AEC和HPF功能。
...
赋值给[ot\_ai\_talk\_vqe\_cfg](#ZH-CN_TOPIC_0000002408099574)结构体成员open\_mask表示开启AEC功能。如open\_mask =OT\_AI\_TALKVQE\_MASK\_AEC |  [OT\_AI\_TALKVQE\_MASK\_HPF](#ZH-CN_TOPIC_0000002408259406)；表示开启AEC和HPF功能。
...
赋值给[ot\_ai\_talk\_vqe\_cfg](#ZH-CN_TOPIC_0000002408099574)结构体成员open\_mask表示开启AGC功能。如open\_mask =  [OT\_AI\_TALKVQE\_MASK\_AEC](#ZH-CN_TOPIC_0000002408099426)  | OT\_AI\_TALKVQE\_MASK\_AGC；表示开启AEC和AGC功能。
...
赋值给[ot\_ai\_talk\_vqe\_cfg](#ZH-CN_TOPIC_0000002408099574)结构体成员open\_mask表示开启EQ功能。如open\_mask =  [OT\_AI\_TALKVQE\_MASK\_AEC](#ZH-CN_TOPIC_0000002408099426)  | OT\_AI\_TALKVQE\_MASK\_EQ；表示开启AEC和EQ功能。
...
赋值给[ot\_ai\_talk\_vqe\_cfg](#ZH-CN_TOPIC_0000002408099574)结构体成员open\_mask表示开启ANR功能。如open\_mask =  [OT\_AI\_TALKVQE\_MASK\_AEC](#ZH-CN_TOPIC_0000002408099426)  | OT\_AI\_TALKVQE\_MASK\_ANR；表示开启AEC和ANR功能。
...
赋值给[ot\_ai\_record\_vqe\_cfg](#ZH-CN_TOPIC_0000002441658953)结构体成员open\_mask表示开启HPF功能。如open\_mask = OT\_AI\_RECORDVQE\_MASK\_HPF |  [OT\_AI\_RECORDVQE\_MASK\_HDR](#ZH-CN_TOPIC_0000002408099506)；表示开启HPF和HDR功能。
...
赋值给[ot\_ai\_record\_vqe\_cfg](#ZH-CN_TOPIC_0000002441658953)结构体成员open\_mask表示开启RNR功能。如open\_mask =  [OT\_AI\_RECORDVQE\_MASK\_HPF](#ZH-CN_TOPIC_0000002408099610)  | OT\_AI\_RECORDVQE\_MASK\_RNR；表示开启HPF和RNR功能。
...
赋值给[ot\_ai\_record\_vqe\_cfg](#ZH-CN_TOPIC_0000002441658953)结构体成员open\_mask表示开启HDR功能。如open\_mask =  [OT\_AI\_RECORDVQE\_MASK\_HPF](#ZH-CN_TOPIC_0000002408099610)  | OT\_AI\_RECORDVQE\_MASK\_HDR；表示开启HPF和HDR功能。
...
赋值给[ot\_ai\_record\_vqe\_cfg](#ZH-CN_TOPIC_0000002441658953)结构体成员open\_mask表示开启DRC功能。如open\_mask =  [OT\_AI\_RECORDVQE\_MASK\_HPF](#ZH-CN_TOPIC_0000002408099610)  | OT\_AI\_RECORDVQE\_MASK\_DRC；表示开启HPF和DRC功能。
...
赋值给[ot\_ai\_record\_vqe\_cfg](#ZH-CN_TOPIC_0000002441658953)结构体成员open\_mask表示开启EQ功能。如open\_mask =  [OT\_AI\_RECORDVQE\_MASK\_HPF](#ZH-CN_TOPIC_0000002408099610)  | OT\_AI\_RECORDVQE\_MASK\_EQ；表示开启HPF和EQ功能。
...
赋值给[ot\_ai\_record\_vqe\_cfg](#ZH-CN_TOPIC_0000002441658953)结构体成员open\_mask表示开启AGC功能。如open\_mask =[OT\_AI\_RECORDVQE\_MASK\_HPF](#ZH-CN_TOPIC_0000002408099610)  | OT\_AI\_RECORDVQE\_MASK\_AGC；表示开启HPF和AGC功能。
...
赋值给[ot\_ai\_talk\_vqe\_v2\_cfg](#ZH-CN_TOPIC_0000002441658913)结构体成员open\_mask表示开启PNR功能。如open\_mask = OT\_AI\_TALKVQEV2\_MASK\_PNR |  [OT\_AI\_TALKVQEV2\_MASK\_NR](#ZH-CN_TOPIC_0000002408259414)；表示开启PNR和NR功能。
...
赋值给[ot\_ai\_talk\_vqe\_v2\_cfg](#ZH-CN_TOPIC_0000002441658913)结构体成员open\_mask表示开启NR功能。如open\_mask =  [OT\_AI\_TALKVQEV2\_MASK\_PNR](#ZH-CN_TOPIC_0000002408259510)  | OT\_AI\_TALKVQEV2\_MASK\_NR；表示开启PNR和NR功能。
...
赋值给[ot\_ai\_talk\_vqe\_v2\_cfg](#ZH-CN_TOPIC_0000002441658913)结构体成员open\_mask表示开启EQ功能。如open\_mask =  [OT\_AI\_TALKVQEV2\_MASK\_PNR](#ZH-CN_TOPIC_0000002408259510)  |  [OT\_AI\_TALKVQEV2\_MASK\_NR](#ZH-CN_TOPIC_0000002408259414)；表示开启PNR和NR功能。
...
赋值给[ot\_ai\_talk\_vqe\_v2\_cfg](#ZH-CN_TOPIC_0000002441658913)结构体成员open\_mask表示开启AGC功能。如open\_mask =  [OT\_AI\_TALKVQEV2\_MASK\_PNR](#ZH-CN_TOPIC_0000002408259510)  |  [OT\_AI\_TALKVQEV2\_MASK\_NR](#ZH-CN_TOPIC_0000002408259414)；表示开启PNR和NR功能。
...
赋值给[ot\_ai\_talk\_vqe\_v2\_cfg](#ZH-CN_TOPIC_0000002441658913)结构体成员open\_mask表示开启DRC功能。如open\_mask =  [OT\_AI\_TALKVQEV2\_MASK\_PNR](#ZH-CN_TOPIC_0000002408259510)  |  [OT\_AI\_TALKVQEV2\_MASK\_NR](#ZH-CN_TOPIC_0000002408259414)；表示开启PNR和NR功能。
...
赋值给[ot\_ai\_talk\_vqe\_v2\_cfg](#ZH-CN_TOPIC_0000002441658913)结构体成员open\_mask表示开启LIMITER功能。如open\_mask =  [OT\_AI\_TALKVQEV2\_MASK\_PNR](#ZH-CN_TOPIC_0000002408259510)  |  [OT\_AI\_TALKVQEV2\_MASK\_NR](#ZH-CN_TOPIC_0000002408259414)；表示开启PNR和NR功能。
...
赋值给[ot\_ai\_talk\_vqe\_v2\_cfg](#ZH-CN_TOPIC_0000002441658913)结构体成员open\_mask表示开启DEREVERB功能。如open\_mask =  [OT\_AI\_TALKVQEV2\_MASK\_PNR](#ZH-CN_TOPIC_0000002408259510)  |  [OT\_AI\_TALKVQEV2\_MASK\_NR](#ZH-CN_TOPIC_0000002408259414)；表示开启PNR和NR功能。
...
赋值给[ot\_ai\_talk\_vqe\_v2\_cfg](#ZH-CN_TOPIC_0000002441658913)结构体成员open\_mask表示开启FMP功能。如open\_mask =  [OT\_AI\_TALKVQEV2\_MASK\_PNR](#ZH-CN_TOPIC_0000002408259510)  |  [OT\_AI\_TALKVQEV2\_MASK\_NR](#ZH-CN_TOPIC_0000002408259414)；表示开启PNR和NR功能。
...
赋值给[ot\_ai\_talk\_vqe\_v2\_cfg](#ZH-CN_TOPIC_0000002441658913)结构体成员open\_mask表示开启WNR功能。如open\_mask =  [OT\_AI\_TALKVQEV2\_MASK\_PNR](#ZH-CN_TOPIC_0000002408259510)  |  [OT\_AI\_TALKVQEV2\_MASK\_NR](#ZH-CN_TOPIC_0000002408259414)；表示开启PNR和NR功能。
...
赋值给[ot\_ai\_talk\_vqe\_v2\_cfg](#ZH-CN_TOPIC_0000002441658913)结构体成员open\_mask表示开启AEC功能。如open\_mask =  [OT\_AI\_TALKVQEV2\_MASK\_PNR](#ZH-CN_TOPIC_0000002408259510)  |  [OT\_AI\_TALKVQEV2\_MASK\_NR](#ZH-CN_TOPIC_0000002408259414)；表示开启PNR和NR功能。
...
赋值给[ot\_ai\_talk\_vqe\_v2\_cfg](#ZH-CN_TOPIC_0000002441658913)结构体成员open\_mask表示开启HS功能。如open\_mask =[OT\_AI\_TALKVQEV2\_MASK\_PNR](#ZH-CN_TOPIC_0000002408259510)  |   [OT\_AI\_TALKVQEV2\_MASK\_NR](#ZH-CN_TOPIC_0000002408259414)；表示开启PNR和NR功能。
...
赋值给[ot\_ao\_vqe\_cfg](#ZH-CN_TOPIC_0000002408259502)结构体成员open\_mask表示开启HPF功能。如open\_mask =  [OT\_AO\_VQE\_MASK\_AGC](#ZH-CN_TOPIC_0000002408099634)  |  [OT\_AO\_VQE\_MASK\_HPF](#ZH-CN_TOPIC_0000002408099450)；表示开启AGC和HPF功能。
...
赋值给[ot\_ao\_vqe\_cfg](#ZH-CN_TOPIC_0000002408259502)结构体成员open\_mask表示开启ANR 功能。如open\_mask =  [OT\_AO\_VQE\_MASK\_AGC](#ZH-CN_TOPIC_0000002408099634)  |  [OT\_AO\_VQE\_MASK\_ANR](#ZH-CN_TOPIC_0000002441698773)；表示开启AGC和ANR功能。
...
赋值给[ot\_ao\_vqe\_cfg](#ZH-CN_TOPIC_0000002408259502)结构体成员open\_mask表示开启AGC 功能。如open\_mask = OT\_AO\_VQE\_MASK\_AGC |  [OT\_AO\_VQE\_MASK\_EQ](#ZH-CN_TOPIC_0000002408099510)；表示开启AGC和EQ 功能。
...
赋值给[ot\_ao\_vqe\_cfg](#ZH-CN_TOPIC_0000002408259502)结构体成员open\_mask表示开启EQ功能。如open\_mask =  [OT\_AO\_VQE\_MASK\_AGC](#ZH-CN_TOPIC_0000002408099634)  | OT\_AO\_VQE\_MASK\_EQ；表示开启AGC和EQ 功能。
...
[ot\_audio\_save\_file\_info](#ZH-CN_TOPIC_0000002408099470)
...
[ot\_audio\_eq\_cfg](#ZH-CN_TOPIC_0000002441658909)
...
[ot\_ai\_drc\_cfg](#ZH-CN_TOPIC_0000002441658905)
...
[ot\_ai\_aec\_cfg](#ZH-CN_TOPIC_0000002408099454)
...
[ot\_ai\_talk\_v2\_eq\_cfg](#ZH-CN_TOPIC_0000002408099518)
...
[ot\_aio\_attr](#ZH-CN_TOPIC_0000002441658845)
...
-   当用户模式开启时，以上各个高级参数才生效，否则按照[ot\_ai\_talk\_vqe\_cfg](#ZH-CN_TOPIC_0000002408099574)/[ot\_ao\_vqe\_cfg](#ZH-CN_TOPIC_0000002408259502)/[ot\_ai\_record\_vqe\_cfg](#ZH-CN_TOPIC_0000002441658953)中的工作模式work\_state对应的默认值来配置。
-   配置参数时，只有在用户模式开启时，才会对高级参数做正确性检查，只有正确的高级参数才能配置成功。
-   [ot\_ai\_talk\_vqe\_cfg](#ZH-CN_TOPIC_0000002408099574)/[ot\_ao\_vqe\_cfg](#ZH-CN_TOPIC_0000002408259502)/[ot\_ai\_record\_vqe\_cfg](#ZH-CN_TOPIC_0000002441658953)中的AGC只支持对信号电平进行放大，不支持对信号电平进行缩小。

【相关数据类型及接口】

-   [ot\_ao\_vqe\_cfg](#ZH-CN_TOPIC_0000002408259502)
-   [ot\_ai\_talk\_vqe\_cfg](#ZH-CN_TOPIC_0000002408099574)
-   [ot\_ai\_record\_vqe\_cfg](#ZH-CN_TOPIC_0000002441658953)
...
-   当用户模式开启时，其他参数才生效，否则按照[ot\_ai\_talk\_vqe\_cfg](#ZH-CN_TOPIC_0000002408099574)中的工作模式work\_state对应的默认值来配置。
-   配置参数时，只有在用户模式开启时，才会对高级参数做正确性检查，只有正确的高级参数才能配置成功。
...
-   当用户模式开启时，以上各个高级参数才生效，否则按照[ot\_ai\_talk\_vqe\_cfg](#ZH-CN_TOPIC_0000002408099574)  /[ot\_ao\_vqe\_cfg](#ZH-CN_TOPIC_0000002408259502)中的工作模式work\_state对应的默认值来配置。
-   配置参数时，只有在用户模式开启时，才会对高级参数做正确性检查，只有正确的高级参数才能配置成功。
...
-   当用户模式开启时，高级参数才生效，否则按照[ot\_ai\_talk\_vqe\_cfg](#ZH-CN_TOPIC_0000002408099574)/[ot\_ao\_vqe\_cfg](#ZH-CN_TOPIC_0000002408259502)/[ot\_ai\_record\_vqe\_cfg](#ZH-CN_TOPIC_0000002441658953)中的工作模式对应的默认值来配置。
-   配置参数时，只有在用户模式开启时，才会对高级参数做正确性检查，只有正确的高级参数才能配置成功。
...
-   当用户模式开启时，以上各个高级参数才生效，否则按照[ot\_ai\_talk\_vqe\_v2\_cfg](#ZH-CN_TOPIC_0000002441658913)中的工作模式work\_state对应的默认值来配置。
-   配置参数时，只有在用户模式开启时，才会对高级参数做正确性检查，只有正确的高级参数才能配置成功。

【相关数据类型及接口】

[ot\_ai\_talk\_vqe\_v2\_cfg](#ZH-CN_TOPIC_0000002441658913)
...
-   当用户模式开启时，以上各个高级参数才生效，否则按照[ot\_ai\_talk\_vqe\_v2\_cfg](#ZH-CN_TOPIC_0000002441658913)中的工作模式enWorkstate对应的默认值来配置。
-   配置参数时，只有在用户模式开启时，才会对高级参数做正确性检查，只有正确的高级参数才能配置成功。
...
-   当前仅支持in\_chn\_num等于out\_chn\_num的设置。
    -   当AI设备的声道属性为OT\_AUDIO\_SOUND\_MODE\_MONO时，in\_chn\_num、out\_chn\_num需设置为1；
    -   当AI设备的声道属性为OT\_AUDIO\_SOUND\_MODE\_STEREO时，in\_chn\_num、out\_chn\_num需设置为2。
...
[ot\_ai\_chn\_attr](#ZH-CN_TOPIC_0000002408259490)
...
-   [OT\_AENC\_MAX\_CHN\_NUM](#ZH-CN_TOPIC_0000002441659005)：定义音频编码通道的最大个数。
...
-   [ot\_aenc\_encoder](#ZH-CN_TOPIC_0000002408259534)：定义编码器属性结构体。
...
[ot\_aenc\_encoder](#ZH-CN_TOPIC_0000002408259534)
...
[ot\_g726\_bps](#ZH-CN_TOPIC_0000002441658921)
...
[ot\_adpcm\_type](#ZH-CN_TOPIC_0000002408259446)
...
-   [OT\_MAX\_AUDIO\_FRAME\_NUM](#ZH-CN_TOPIC_0000002408259486)：定义最大音频解码缓存帧数。
...
-   [ot\_adec\_chn\_param](#ZH-CN_TOPIC_0000002408099630)：定义音频解码通道状态结构体。
...
[ot\_adec\_decoder](#ZH-CN_TOPIC_0000002441658889)
...
-   [ot\_acodec\_fs](#ZH-CN_TOPIC_0000002441658829)：定义I<sup>2</sup>S接口的采样率选择。
-   [ot\_acodec\_mixer](#ZH-CN_TOPIC_0000002441698765)：定义内置Audio Codec 输入选择。
-   [ot\_acodec\_volume\_ctrl](#ZH-CN_TOPIC_0000002408099670)：定义内置Audio Codec音量控制结构体。
