...
- **hispark_aifly_patch**：Hi3403V100 芯片专用补丁
  ...
  4. `0004-kernel-drm-support.patch` - DHCP 支持
  5. `0005-kernel-dhcp-support.patch` - DRM 显示支持
...
| 产品名称 | 芯片 | 内核版本 | 系统类型 | 应用领域 |
|---------|------|---------|---------|---------|
| ipcamera_hispark_aifly_linux | Hi3403V100 | Linux 6.6 | Small | 智慧视觉、AI 计算 |
| ipcamera_hispark_aiflylite_linux | Hi3519AV200 | Linux 6.6 | Small | 智慧视觉、AI 计算 |
