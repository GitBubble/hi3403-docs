...
SVP-related data types and data structures are defined as follows:

-   [ot\_svp\_img\_type](#ZH-CN_TOPIC_0000002471091210): Defines the image types supported by 2D generalized images.
...
-   [OT\_SVP\_IMG\_ADDR\_NUM](#ZH-CN_TOPIC_0000002470931272): Defines the number of address channels.

Fixed-point data types:

-   [ot\_svp\_data](#ZH-CN_TOPIC_0000002470931244): Defines 2D image information in bytes.
...
-   [ot\_svp\_lut](#ZH-CN_TOPIC_0000002503971221): Defines a lookup table structure.

IVE-related data types and data structures are defined as follows:

-   [ot\_ive\_handle](#ZH-CN_TOPIC_0000002471091250): Defines the IVE handle.
...
-   [ot\_ive\_cnn\_conv\_pooling](#ZH-CN_TOPIC_0000002471091306): Defines CNN single-layer Conv-ReLU-Pooling operation package parameter structure.
...
-   [ot\_ive\_hog\_ctrl](#ZH-CN_TOPIC_0000002470931248): Defines HOG (Histogram of Oriented Gradient) feature calculation control parameters.

## SVP-Related Data Types and Data Structures<a name="ZH-CN_TOPIC_0000002471091256"></a>

### ot\_svp\_img\_type<a name="ZH-CN_TOPIC_0000002471091210"></a>

【Description】

Defines the image types supported by 2D generalized images.
...
Defines 2D generalized image information.
...
Defines the number of address channels.
...
Defines the stride array length.
...
## Fixed-Point Data Types<a name="ZH-CN_TOPIC_0000002471091272"></a>
...
-   The number x after u indicates x unsigned bits for the integer part.
...
-   From left to right, high bits to low bits.
...
Defines 2D data information in bytes.
...
Represents 2D data in bytes; can be converted to/from [ot\_svp\_img](#ZH-CN_TOPIC_0000002504091103).
...
Defines 2D source data information in bytes.
...
Defines 2D output data information in bytes.
...
Defines a point information structure represented by u16.
...
<table><thead align="left"><tr><th>Member Name</th><th>Description</th></tr></thead>
...
Defines a point information structure represented by s16.
...
Defines a point information structure represented by s25q7.
...
Defines a point information structure represented by u14q2.
...
Defines a rectangle information structure represented by u32.
...
Defines a rectangle information structure represented by u16.
...
Defines a rectangle information structure represented by s24q8.
...
Defines a lookup table structure.
...
## IVE-Related Data Types and Data Structures<a name="ZH-CN_TOPIC_0000002503971225"></a>

### ot\_ive\_handle<a name="ZH-CN_TOPIC_0000002471091250"></a>

【Description】

Defines the IVE handle.
...
Defines the number of mapping lookup table entries.
...
Defines the maximum number of connected regions.
...
Defines the maximum number of Shi-Tomasi-like corners.
...
Reserved field array length 12.
...
Reserved field array length 14.
...
IVE module related parameter definition.
...
-   OT\_IVE\_CSC\_MODE\_VIDEO\_BT601\_YUV\_TO\_RGB and OT\_IVE\_CSC\_MODE\_VIDEO\_BT709\_YUV\_TO\_RGB modes: output satisfies 16 <= R, G, B <= 235.
...
-   OT\_IVE\_CSC\_MODE\_PIC\_BT601\_RGB\_TO\_YUV and OT\_IVE\_CSC\_MODE\_PIC\_BT709\_RGB\_TO\_YUV modes: output satisfies Y [16, 235], U/V [16, 240].
...
Defines composite template filter plus color space conversion control information.
...
Only supports 4 modes of YUV2RGB.
...
Defines the output format for gradient magnitude and angle calculation.
...
Defines control information for gradient magnitude and angle calculation.
...
Defines dilation control information.
...
Defines erosion control information.
...
For calculation formulas, see [Notes] in ss\_mpi\_ive\_threshold. For diagrams, see the 8 thresholding mode diagram.
