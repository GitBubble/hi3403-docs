...
Data is processed into viewable YUV/RGB (Denoising, White Balance, Color, HDR, Gamma…). [Reference](../multimedia/isp/index.md) `MPP`
: Media Processing Platform - HiSilicon's multimedia processing software framework. video collection,
Codec, image processing, audio, and display output are all in MPP. [Reference](../multimedia/mpp/index.md) `MMZ`
...
: Graphics FrameBuffer Group——Graphics framebuffer management. [Reference](../multimedia/graphics/gfbg/index.md) `GDC`
...
The model is converted into an SVP executable `.om` file. [Reference](../multimedia/atc/index.md) `AMCT`
: Ascend Model Compression Tool - model quantification tool. FP32 → INT8/INT16,
The model becomes smaller and runs faster. [Reference](../multimedia/amct/index.md) `IVE`
...
: Heterogeneous NR (Noise Reduction)——Heterogeneous noise reduction. [Reference](../multimedia/cv/hnr/index.md) `DIS`
: Digital Image Stabilization——Digital image stabilization. [Reference](../multimedia/dis/index.md) `MotionFusion`
: Fusion of motion information (gyroscope/IMU) and image information for electronic image stabilization and super-resolution. [Reference](../multimedia/motionfusion/index.md) ## Security and encryption `KLAD`
...
: Universal Bootloader. Hi3403 uses v2020.01. [Reference](../soc-linux/uboot/index.md) `bl31`
...
: Community script to build Ubuntu image with one click. [Reference](../tools/hi3403-build.md) `BurnTool`
: HiSilicon’s official graphics flashing tool. [Reference](../tools/burntool/index.md) `MindCmd`
: Board-side command line debugging tool, including AI one-click inference. [Reference](../tools/mindcmd/index.md) `ToolPlatform`
: HiSilicon visual debugging platform. [Reference](../tools/toolplatform/index.md) `SDK`
...
: Development board OEM. They are Topeet, Wildfire, Ebaina, RKH, and Zhongshan Kuangshi. [Development board comparison](../get-started/board-picker.md) --- Did you find the term? Welcome [Raise a PR](../community/contributing.md) to add a line.