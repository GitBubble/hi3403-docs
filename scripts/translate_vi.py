...
translations = {
    ...
    "Hi3403V100视频输入通道功能如": "The Hi3403V100 video input channel functions are shown in ",
    ...
    "章节的": " section for ",
    "Hi3403V100 VI只有一个物理通道，支持8个扩展通道。": "Hi3403V100 VI has only one physical channel, supporting 8 extension channels.",
    "Hi3403V100物理通道支持的典型分辨率如3840x2160@60fps、3840x2160@30fps、1080p@240fps、1080p@120fps、1080p@60fps、1080p@30fps等。": "Typical resolutions supported by the Hi3403V100 physical channel include 3840x2160@60fps, 3840x2160@30fps, 1080p@240fps, 1080p@120fps, 1080p@60fps, 1080p@30fps, etc.",
    ...
    "Hi3403V100有两个子模块支持BAS功能，如": "Hi3403V100 has two submodules that support BAS functions, as shown in ",
    "DEV和前端时序输入的接口有约束关系。例如Hi3403V100前端需要接入BT.1120，且选择了第0组BT.1120管脚，PIPE应该和DEV3绑定，才能正常接收数据。": "There are constraints between the DEV and the front-end timing input interface. For example, if the Hi3403V100 front end needs to connect to BT.1120 and the 0th BT.1120 pin group is selected, the PIPE should be bound to DEV3 to receive data correctly.",
    "Hi3403V100 DEV和时序输入接口的约束关系如": "The constraints between Hi3403V100 DEV and timing input interfaces are shown in ",
