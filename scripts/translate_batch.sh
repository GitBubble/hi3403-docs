...
sed -i '' 's/SS524V100\/SS522V100\/Hi3403V100的VPSS IP个数是1，vpss hardware node queue和vpss int work status中只有VPSS0相关的信息。/SS524V100\/SS522V100\/Hi3403V100 have 1 VPSS IP. vpss hardware node queue and vpss int work status only contain VPSS0-related info./g' "13-proc调试信息-1316-1329.en.md"
sed -i '' 's/SS528V100\/SS625V100\/SS524V100\/SS522V100\/Hi3403V100\/SS626V100无Proc队列，Proc队列的节点数是0。/SS528V100\/SS625V100\/SS524V100\/SS522V100\/Hi3403V100\/SS626V100 have no Proc queue. Proc queue node count is 0./g' "13-proc调试信息-1316-1329.en.md"
